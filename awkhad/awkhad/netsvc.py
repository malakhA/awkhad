...
class PostgreSQLHandler(logging.Handler):
    ...
    def emit(self, record):
        ...
        if not dbname:
            return
        with tools.ignore(Exception), tools.mute_logger('awkhad.sql_db'), sql_db.db_connect(dbname, allow_uri=True).cursor() as cr:
...
def init_logger():
    ...
    # Check that handler.stream has a fileno() method: when running ZgUI
...
DEFAULT_LOG_CONFIGURATION = [
    'awkhad.http.rpc.request:INFO',
    'awkhad.http.rpc.response:INFO',
    ':INFO',
]
PSEUDOCONFIG_MAPPER = {
    'debug_rpc_answer': ['awkhad:DEBUG', 'awkhad.sql_db:INFO', 'awkhad.http.rpc:DEBUG'],
    'debug_rpc': ['awkhad:DEBUG', 'awkhad.sql_db:INFO', 'awkhad.http.rpc.request:DEBUG'],
    'debug': ['awkhad:DEBUG', 'awkhad.sql_db:INFO'],
    'debug_sql': ['awkhad.sql_db:DEBUG'],
    'info': [],
    'warn': ['awkhad:WARNING', 'werkzeug:WARNING'],
    'error': ['awkhad:ERROR', 'werkzeug:ERROR'],
    'critical': ['awkhad:CRITICAL', 'werkzeug:CRITICAL'],
}
