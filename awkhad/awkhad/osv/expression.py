...
term representation was ['=', 'company_id.name', 'ZgUI']. Used in a
...
ZgUI will use the SQL function 'unaccent' when available for the
...
Finally, to instruct ZgUI to really use the unaccent function, you have to
...
def get_unaccent_wrapper(cr):
    if awkhad.registry(cr.dbname).has_unaccent:
