...
from awkhad.modules.module import get_module_root, MANIFEST_NAMES
from awkhad.service.db import _create_empty_database, DatabaseExists


class Start(Command):
    """Quick start the Awkhad server for your project"""
    ...
    def run(self, cmdargs):
        ...
        try:
            ...
            awkhad.tools.config['init']['base'] = True
