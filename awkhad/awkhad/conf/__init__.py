...
For now, configuration code is in zgui.tools.config. It is in mainly
...
To initialize properly this module, zgui.tools.config.parse_config()
must be used.

"""

# Paths to search for ZgUI addons.
addons_paths = []
...
# installed (i.e. the majority of ZgUI addons). This is set with the --load
# command-line option.
server_wide_modules = []
