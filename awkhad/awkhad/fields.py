...
class Field(MetaField('DummyField', (object,), {})):
    """ The field descriptor contains the field definition, and manages accesses
        ...
        :param str group_operator: aggregate function used by :meth:`~awkhad.models.Model.read_group`
        ...
        recordset. The decorator :meth:`awkhad.api.depends` must be applied on
        ...
        is extended (see :class:`~awkhad.models.Model`), one can also extend
...
class Monetary(Field):
    ...
    def convert_to_cache(self, value, record, validate=True):
        ...
        if validate and record[self.currency_field]:
            # FIXME @rco-awkhad: currency may not be already initialized if it is
...
class Binary(Field):
    ...
    def convert_to_column(self, value, record, values=None, validate=True):
        ...
        # the legacy ZgUI convention is to transfer and store binaries
