...
import awkhad
from awkhad.tests import common, tagged
from awkhad.tools.misc import file_open, mute_logger
...
class TestTermCount(common.TransactionCase):
    ...
    def test_count_term(self):
        ...
        """
        awkhad.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', module_name='test_translation_import', verbose=False)
    ...
    def test_count_term_module(self):
        ...
        """
        awkhad.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', verbose=False)
    ...
    def test_noupdate(self):
        ...
        awkhad.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_FR', module_name='test_translation_import', verbose=False, context={'overwrite': True})
    ...
    def test_lang_with_base(self):
        awkhad.tools.trans_load(self.cr, 'test_translation_import/i18n/fr.po', 'fr_BE', module_name='test_translation_import', verbose=False)
        awkhad.tools.trans_load(self.cr, 'test_translation_import/i18n/fr_BE.po', 'fr_BE', module_name='test_translation_import', verbose=False, context={'overwrite': True})
    ...
    def test_export_empty_string(self):
        ...
        def update_translations(context=None):
            ...
            with closing(io.BytesIO()) as bufferobj:
                awkhad.tools.trans_export('fr_FR', ['test_translation_import'], bufferobj, 'po', self.cr)
                bufferobj.name = 'test_translation_import/i18n/fr.po'
                awkhad.tools.trans_load_data(self.cr, bufferobj, 'po', 'fr_FR', verbose=False, context=context)
    ...
    def test_import_from_po_file(self):
        ...
        with mute_logger('awkhad.addons.base.models.res_lang'):
...
class TestTranslationFlow(common.TransactionCase):
    ...
    def test_export_import(self):
        ...
        with mute_logger('awkhad.addons.base.models.ir_translation'):
