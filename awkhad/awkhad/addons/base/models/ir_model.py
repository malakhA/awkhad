...
from awkhad import api, fields, models, SUPERUSER_ID, tools,  _
from awkhad.exceptions import AccessError, UserError, ValidationError
...
class IrModel(models.Model):
    ...
    def unlink(self):
        ...
        # reload is done independently in awkhad.modules.loading.
        if not self._context.get(MODULE_UNINSTALL_FLAG):
...
class IrModelConstraint(models.Model):
    """
    This model tracks PostgreSQL foreign keys and constraints used by Awkhad
    models.
    """
...
class IrModelRelation(models.Model):
    """
    This model tracks PostgreSQL tables used to implement Awkhad many2many
    relations.
    """
...
class IrModelData(models.Model):
    """Holds external identifier keys for records in the database.
       This has two main uses:
           ...
           * allows tracking the origin of data installed by Awkhad
