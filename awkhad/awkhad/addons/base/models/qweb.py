...
from awkhad.tools import pycompat, freehash
    ...
    def _base_module(self):
        ...
        * string_types (replacement for basestring)
        ...
        return ast.parse(dedent("""
            ...
            from awkhad.tools.pycompat import to_text, string_types
            from awkhad.addons.base.models.qweb import escape, foreach_iterator
            """))
