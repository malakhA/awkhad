...
from awkhad import api, fields, models, tools, SUPERUSER_ID, exceptions, _
from awkhad.exceptions import AccessError, ValidationError
from awkhad.tools import config, human_size, ustr, html_escape
from awkhad.tools.mimetypes import guess_mimetype
from awkhad.tools import crop_image, image_resize_image
...
class IrAttachment(models.Model):
    """Attachments are used to link binary files or url to any zgui document.
