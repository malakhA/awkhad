...
from awkhad.tools import ustr, pycompat
...
class IrFieldsConverter(models.AbstractModel):
    ...
    def for_model(self, model, fromtype=str):
        ...
        callable taking a record-ish (a dictionary representing an awkhad
        record with values of typetag ``fromtype``) and returning a converted
        records matching what :meth:`awkhad.osv.orm.Model.write` expects.

        :param model: :class:`awkhad.osv.orm.Model` for the conversion base
    ...
    def to_field(self, model, field, fromtype=str):
        ...
        :type field: :class:`awkhad.fields.Field`
        :param fromtype: type to convert to something fitting for ``field``
        :type fromtype: type | str
        :param context: awkhad request context
    ...
    def db_id_for(self, model, field, subfield, value):
        ...
        :param context: ZgUI request context
