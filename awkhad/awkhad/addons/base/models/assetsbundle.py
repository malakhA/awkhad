...
from awkhad import fields, tools, SUPERUSER_ID
from awkhad.tools.pycompat import string_types, to_text
from awkhad.http import request
from awkhad.modules.module import get_resource_path
from .qweb import escape
import psycopg2
from awkhad.tools import func, misc
        ...
        return """
            (function (message) {
                ...
                document.addEventListener("DOMContentLoaded", function () {
                    ...
                    if (typeof awkhad === "undefined") return;

                    awkhad.define("AssetsBundle.ErrorMessage", function (require) {
                        "use strict";
    ...
    def compile_css(self, compiler, source):
        ...
        def sanitize(matchobj):
            ...
            if '.' not in ref and line not in imports and not ref.startswith(('.', '/', '~')):
                imports.append(line)
                return line
            msg = "Local import '%s' is forbidden for security reasons. Please remove all @import {your_file} imports in your custom files. In Awkhad you have to import all files in the assets, and not through the @import statement." % ref
            _logger.warning(msg)
