...
from awkhad.osv.expression import NEGATIVE_TERM_OPERATORS, FALSE_DOMAIN
...
# here to init the T1 fonts cache at the start-up of Awkhad so that rendering of barcode in multiple
...
# Check the presence of Wkhtmltopdf and return its version at Awkhad start-up
...
try:
    ...
    if match:
        ...
        if config['workers'] == 1:
            _logger.info('You need to start Awkhad with at least two workers to print a pdf version of the reports.')
