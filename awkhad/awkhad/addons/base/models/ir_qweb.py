...
from awkhad import api, models, tools
from awkhad.tools.safe_eval import assert_valid_codeobj, _BUILTINS, _SAFE_OPCODES
from awkhad.http import request
from awkhad.modules.module import get_resource_path

from awkhad.addons.base.models.qweb import QWeb, Contextifier
from awkhad.addons.base.models.assetsbundle import AssetsBundle
    ...
    * to customize ``t-field`` rendering, subclass ``ir.qweb.field`` and
    ...
    def _get_asset_content(self, xmlid, options):
        ...
        def get_modules_order():
            if request:
                from awkhad.addons.web.controllers.main import module_boot
