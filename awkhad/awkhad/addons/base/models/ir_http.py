...
import awkhad
from awkhad import api, http, models, tools, SUPERUSER_ID
from awkhad.exceptions import AccessDenied, AccessError
from awkhad.http import request, STATIC_CACHE, content_disposition
from awkhad.tools import pycompat, consteq
from awkhad.tools.mimetypes import guess_mimetype
from ast import literal_eval
from awkhad.modules.module import get_resource_path, get_module_path
...
class IrHttp(models.AbstractModel):
    ...
    def routing_map(cls):
        if not hasattr(cls, '_routing_map'):
            ...
            if tools.config['test_enable'] and awkhad.modules.module.current_test:
                installed.add(awkhad.modules.module.current_test)
            mods = [''] + awkhad.conf.server_wide_modules + sorted(installed)
