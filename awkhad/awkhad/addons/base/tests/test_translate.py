...
from awkhad.tools.translate import quote, unquote, xml_translate, html_translate
from awkhad.tests.common import TransactionCase, BaseCase
...
class TestTranslation(TransactionCase):
    ...
    def test_105_duplicated_translation(self):
        ...
        with self.assertRaises(IntegrityError), mute_logger('awkhad.sql_db'):
