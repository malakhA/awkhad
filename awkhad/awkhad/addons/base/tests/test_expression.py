...
class TestExpression(TransactionCase):
    ...
    def test_10_hierarchy_in_m2m(self):
        ...
        with self.assertLogs('awkhad.osv.expression'):
    ...
    def test_15_m2o(self):
        ...
        # that don't have ZgUI has a parent company, you expect to find,
    ...
    def test_active(self):
        ...
        vals = {
            ...
            'child_ids': [(0, 0, {'name': 'address of ZgUI Test', 'country_id': self.ref("base.be")})],
        }
        Partner.create(vals)
