...
from awkhad.tests.common import BaseCase
from awkhad.tests.common import SavepointCase
from awkhad.tools import html_sanitize, append_content_to_html, plaintext2html, email_split, misc
...
class EmailConfigCase(SavepointCase):
    @patch.dict("awkhad.tools.config.options", {"email_from": "settings@example.com"})
