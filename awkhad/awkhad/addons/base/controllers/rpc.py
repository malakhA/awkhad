...
from awkhad.http import Controller, dispatch_rpc, request, route
from awkhad.service import wsgi_server
from awkhad.fields import Date, Datetime


class AwkhadMarshaller(xmlrpc.client.Marshaller):
...
xmlrpc.client.Marshaller = AwkhadMarshaller
...
class RPC(Controller):
    ...
    def jsonrpc(self, service, method, args):
        """ Method used by client APIs to contact ZgUI. """
