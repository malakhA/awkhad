...
from awkhad.tools import mute_logger, float_repr, pycompat
from awkhad.tools.date_utils import add, subtract, start_of, end_of
...
class TestFields(common.TransactionCase):
    ...
    def test_90_binary_svg(self):
        from awkhad.addons.base.tests.test_mimetypes import SVG
