===================
Profiling Awkhad code
===================

.. warning::

    This tutorial requires :ref:`having installed Awkhad <setup/install>`
    and :doc:`writing Awkhad code <backend>`

Graph a method
==============

Awkhad embeds a profiler of code. This embeded profiler output can be used to
...
.. code:: python
    ...
    from awkhad.tools.misc import profile
    [...]
...
.. code:: python
    ...
    from awkhad.tools.profiler import profile
    [...]
    @profile
    @api.model
    def mymethod(...):
...
.. code:: bash
    ...
    2018-03-28 06:18:23,196 22878 INFO zgui awkhad.tools.profiler:
    calls     queries   ms
    project.task ------------------------ /home/awkhad/src/awkhad/addons/project/models/project.py, 638
...
Sending the SIGQUIT signal to an Awkhad process (only available on POSIX) makes
this process output the current stack trace to log, with info level. When an
awkhad process seems stucked, sending this signal to the process permit to know
what the process is doing, and letting the process continue his job.

Tracing code execution
======================

Instead of sending the SIGQUIT signal to an Awkhad process often enough, to check
...
where <PID> is the process ID of the awkhad process you want to graph. This will
