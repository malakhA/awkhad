...
Aside from manually managing access using custom code, Awkhad provides two main
...
An ORM :class:`~awkhad.fields.Field` can have a ``groups`` attribute
...
* restricted fields are removed from :meth:`~awkhad.models.Model.fields_get`
  responses
