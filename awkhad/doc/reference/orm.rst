...
.. versionadded:: 8.0
    ...
    This page documents the New API added in Awkhad 8.0 which should be the
...
Accessing a relational field (:class:`~awkhad.fields.Many2one`,
:class:`~awkhad.fields.One2many`, :class:`~awkhad.fields.Many2many`)
...
.. danger::
    ...
    (to the same value), use :meth:`~awkhad.models.Model.write`::
...
Awkhad maintains a cache for the fields of the records, so that not every field
...
To avoid reading one field on one record at a time, Awkhad *prefetches* records
...
:meth:`~awkhad.models.Model.filtered`
...
:meth:`~awkhad.models.Model.sorted`
...
:meth:`~awkhad.models.Model.mapped`
...
The :class:`~awkhad.api.Environment` stores various contextual data used by
...
using :attr:`~awkhad.models.Model.env` and gives access to the current user
(:attr:`~awkhad.api.Environment.user`), the cursor
(:attr:`~awkhad.api.Environment.cr`) or the context
(:attr:`~awkhad.api.Environment.context`)::
...
:meth:`~awkhad.models.Model.with_context`
...
:meth:`~awkhad.models.Model.with_env`
...
:meth:`~awkhad.models.Model.search`
   ...
   .. tip:: to just check if any record matches a domain, or count the number
             ...
             :meth:`~awkhad.models.Model.search_count`

:meth:`~awkhad.models.Model.create`
...
:meth:`~awkhad.models.Model.exists`
...
:meth:`~awkhad.api.Environment.ref`
...
:meth:`~awkhad.models.Model.ensure_one`
...
* computed fields are automatically checked and recomputed, they do not need
  an ``onchange``
* for non-computed fields, the :func:`~awkhad.api.onchange` decorator is used
...
.. warning::
    ...
    itself via onchange. This is a webclient limitation - see `#2693 <https://github.com/awkhad/awkhad/issues/2693>`_.

Low-level SQL
-------------

The :attr:`~awkhad.api.Environment.cr` attribute on environments is the
...
Because models use the same cursor and the :class:`~awkhad.api.Environment`
...
:meth:`~awkhad.models.BaseModel.invalidate_cache` method of the
:class:`~awkhad.models.BaseModel` object.
...
Awkhad is currently transitioning from an older (less regular) API, it can be
...
* values of the :class:`~awkhad.api.Environment` (cursor, user id and
  context) are passed explicitly to methods instead
* record data (:attr:`~awkhad.models.Model.ids`) are passed explicitly to
...
Note that a method `create` decorated with :func:`~awkhad.api.model` will always
be called with a single dictionary. A method `create` decorated with the variant
:func:`~awkhad.api.model_create_multi` will always be called with a list of dicts.
...
.. currentmodule:: awkhad.models

.. autoclass:: awkhad.models.Model
    ...
    .. attribute:: _auto
     ...
     .. tip:: To create a model without any table, inherit
              from ``awkhad.models.AbstractModel``

    .. attribute:: _table

        Name of the table backing the model created when
        :attr:`~awkhad.models.Model._auto`, automatically generated by
        default.
    ...
    .. attribute:: _inherits
        ...
        the fields of the :attr:`~awkhad.models.Model._inherits`-ed model but
        ...
        .. warning::
            ...
            :attr:`~awkhad.models.Model._inherits`-ed
    ...
    .. attribute:: _constraints
        ...
        .. deprecated:: 8.0
            ...
            use :func:`~awkhad.api.constrains`
    ...
    .. attribute:: id
        ...
        Identifier :class:`field <awkhad.fields.Field>`
    ...
    .. attribute:: create_date
        ...
        :type: :class:`~awkhad.field.Datetime`
    ...
    .. attribute:: active
        ...
        :type: :class:`~awkhad.fields.Boolean`
    ...
    .. attribute:: sequence
        ...
        :type: :class:`~awkhad.fields.Integer`

    .. attribute:: state

        lifecycle stages of the object, used by the ``states`` attribute on
        :class:`fields <awkhad.fields.Field>`

        :type: :class:`~awkhad.fields.Selection`
    ...
    .. attribute:: parent_id
        ...
        :type: :class:`~awkhad.fields.Many2one`
...
.. autodoc documents descriptors as attributes, even for the *definition* of
   descriptors. As a result automodule:: awkhad.fields lists all the field
...
.. autoclass:: awkhad.fields.Field

.. autoclass:: awkhad.fields.Char
    :show-inheritance:

.. autoclass:: awkhad.fields.Boolean
    :show-inheritance:

.. autoclass:: awkhad.fields.Integer
    :show-inheritance:

.. autoclass:: awkhad.fields.Float
    :show-inheritance:

.. autoclass:: awkhad.fields.Text
    :show-inheritance:

.. autoclass:: awkhad.fields.Selection
    :show-inheritance:

.. autoclass:: awkhad.fields.Html
    :show-inheritance:
...
application, they are heavily used in many popular Awkhad applications such as
logistics or accounting and their misuse can create invisible yet painful
bugs, this excerpt aims to provide Awkhad developers with the knowledge required
...
:func:`~awkhad.fields.Date.to_date` or :func:`~awkhad.fields.Datetime.to_datetime`
...
:class:`~awkhad.fields.Date` and :class:`~awkhad.fields.Datetime`.
These helpers are also available by importing `awkhad.tools.date_utils`.

.. autoclass:: awkhad.fields.Date
    :show-inheritance:
    :members: today, context_today, to_date, to_string, start_of, end_of, add, subtract

.. autoclass:: awkhad.fields.Datetime
    :show-inheritance:
...
.. autoclass:: awkhad.fields.Many2one
    :show-inheritance:

.. autoclass:: awkhad.fields.One2many
    :show-inheritance:

.. autoclass:: awkhad.fields.Many2many
    :show-inheritance:

.. autoclass:: awkhad.fields.Reference
    :show-inheritance:
...
Awkhad provides three different mechanisms to extend models in a modular way:
...
When using the :attr:`~awkhad.models.Model._inherit` and
:attr:`~awkhad.models.Model._name` attributes together, Awkhad creates a new
model using the existing one (provided via
:attr:`~awkhad.models.Model._inherit`) as a base. The new model gets all the
fields, methods and meta-information (defaults & al) from its base.

.. literalinclude:: ../../awkhad/addons/test_documentation_examples/inheritance.py
    :language: python
    :lines: 5-

and using them:

.. literalinclude:: ../../awkhad/addons/test_documentation_examples/tests/test_inheritance.py
    :language: python
    :lines: 10,11,14,19
...
When using :attr:`~awkhad.models.Model._inherit` but leaving out
:attr:`~awkhad.models.Model._name`, the new model replaces the existing one,
...
.. literalinclude:: ../../awkhad/addons/test_documentation_examples/extension.py
    :language: python
    :lines: 7-

.. literalinclude:: ../../awkhad/addons/test_documentation_examples/tests/test_extension.py
    :language: python
    :lines: 10,15
...
at runtime) but less power: using the :attr:`~awkhad.models.Model._inherits`
...
:class:`~awkhad.fields.Reference` fields automatically set up on the parent
model:

.. literalinclude:: ../../awkhad/addons/test_documentation_examples/delegation.py
    :language: python
    :lines: 5-

.. literalinclude:: ../../awkhad/addons/test_documentation_examples/tests/test_delegation.py
    :language: python
    :lines: 11-14,23,28
...
``field_name`` (``str``)
    ...
    a :class:`~awkhad.fields.Many2one` using dot-notation e.g. ``'street'``
...
``operator`` (``str``)
    ...
    ``child_of``
        ...
        :attr:`~awkhad.models.Model._parent_name`).
    ``parent_of``
...
* :meth:`~awkhad.models.Model.search` returns a recordset, no point in e.g.
  browsing its result
* ``fields.related`` and ``fields.function`` are replaced by using a normal
  field type with either a ``related=`` or a ``compute=`` parameter
* :func:`~awkhad.api.depends` on ``compute=`` methods **must be complete**,
...
* the decorators :func:`~awkhad.api.model` and :func:`~awkhad.api.multi` are
  for bridging *when calling from the old API context*, for internal or pure
  new-api (e.g. compute) they are useless
* remove :attr:`~awkhad.models.Model._default`, replace by ``default=``
...
* double check that all fields and methods have different names, there is no
  warning in case of collision (because Python handles it before Awkhad sees
  anything)
* the normal new-api import is ``from awkhad import fields, models``. If
  compatibility decorators are necessary, use ``from awkhad import api,
  fields, models``
* avoid the :func:`~awkhad.api.one` decorator, it probably does not do what
  you expect
* remove explicit definition of :attr:`~awkhad.models.Model.create_uid`,
  :attr:`~awkhad.models.Model.create_date`,
  :attr:`~awkhad.models.Model.write_uid` and
  :attr:`~awkhad.models.Model.write_date` fields: they are now created as
...
* when straight conversion is impossible (semantics can not be bridged) or the
  ...
  implementations for the same method name using :func:`~awkhad.api.v7` and
  :func:`~awkhad.api.v8`. The method should first be defined using the
  old-API style and decorated with :func:`~awkhad.api.v7`, it should then be
  re-defined using the exact same name but the new-API style and decorated
  with :func:`~awkhad.api.v8`. Calls from an old-API context will be
...
* uses of :attr:`~awkhad.models.Model._columns` or
  :attr:`~awkhad.models.Model._all_columns` should be replaced by
  :attr:`~awkhad.models.Model._fields`, which provides access to instances of
  new-style :class:`awkhad.fields.Field` instances (rather than old-style
  :class:`awkhad.osv.fields._column`).

  Non-stored computed fields created using the new API style are *not*
  available in :attr:`~awkhad.models.Model._columns` and can only be
  inspected through :attr:`~awkhad.models.Model._fields`
* reassigning ``self`` in a method is probably unnecessary and may break
  translation introspection
* :class:`~awkhad.api.Environment` objects rely on some threadlocal state,
  which has to be set up before using them. It is necessary to do so using the
  :meth:`awkhad.api.Environment.manage` context manager when trying to use
  the new API in contexts where it hasn't been set up yet, such as new threads
  or a Python interactive environment::

    >>> from awkhad import api, modules
...
:class:`~awkhad.api.Environment` (for :attr:`~awkhad.api.Environment.cr`,
:attr:`~awkhad.api.Environment.user` and
:attr:`~awkhad.api.Environment.context`) or the current recordset (for ``id``
and ``ids``).
...
* disabling it entirely, by decorating a method with
  :func:`~awkhad.api.noguess` there will be no bridging and methods will be
...
* defining the bridge explicitly, this is mostly for methods which are matched
  ...
  (e.g. :func:`~awkhad.api.cr_uid_context`) which also passes the current
  context *by keyword*.
* dual implementations using :func:`~awkhad.api.v7` and
  :func:`~awkhad.api.v8` will be ignored as they provide their own "bridging"
