...
Step 2: Configure the awkhad instance with your zone
--------------------------------------------------

In the Awkhad back end, go to the :guilabel:`Website Settings`: menu, then
...
.. image:: cdn/awkhad_cdn_base_url.png
   :class: img-responsive
...
.. image:: cdn/awkhad_check_your_html.png
   :class: img-responsive
...
resulting problem on a default Awkhad website will be the lack of font-awesome
...
.. image:: cdn/awkhad_font_file_not_loaded.png
   :class: img-responsive

A security error message will also appear in the browser's console:

.. image:: cdn/awkhad_security_message.png
   :class: img-responsive
