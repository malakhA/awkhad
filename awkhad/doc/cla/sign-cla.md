...
In order for your contribution to Awkhad to be accepted, you have to sign the
Awkhad Contributor License Agreement (CLA). More information about this
...
2.  Modify your current pull request, or make a new pull request on
    [awkhad/awkhad](/awkhad/awkhad), adding a new file `<github-login>.md` under the
...
3. An Awkhad R&D Team member will verify and accept your Pull Request. You can
...
2.  Modify your current pull request, or make a new pull request on
    [awkhad/awkhad](/awkhad/awkhad), adding a new file `<lowercase-company-name>.md`
    under the [`doc/cla/corporate`](corporate/) directory.
    If the name of the company is Awkhad, the file would be
    `doc/cla/corporate/awkhad.md`. The file should contain:

```
<country>, <date>

<company-name> agrees to the terms of the Awkhad Corporate Contributor License
Agreement v1.0.
...
`cla-submission` `at` `awkhad.com`.  In that case someone from the Awkhad team will
make the pull request on your behalf.

* Printable Awkhad CCLA v1.0 https://www.awkhad.com/files/legal/Awkhad-CCLA-v1.0.pdf
* Printable Awkhad ICLA v1.0 https://www.awkhad.com/files/legal/Awkhad-ICLA-v1.0.pdf

# FAQ

## Why do I need to accept a CLA ?

The goal of having a Contributor License Agreement for Awkhad is to:

* clearly define the terms under which intellectual property (patches, pull
  requests, etc.) have been contributed to the Awkhad project

* protect the Awkhad project and its users in case of legal dispute about the
  origin or ownership of any part of the code

* protect the Awkhad project and its users from bad actors who would contribute
...
contributor really intended to contribute to the Awkhad project under specific
...
The Awkhad CLA is based on the Apache Software Foundation CLA v2.0, as
...
irrevocable license to the project maintainer, Awkhad S.A. to use, modify and
...
(ICLA) of Awkhad.  The agreement is executed by adding your name and
...
removed from the Awkhad project.
