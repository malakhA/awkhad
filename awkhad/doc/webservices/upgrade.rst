...
This document describes the API used to upgrade an Awkhad database to a
higher version.

It allows a database to be upgraded without ressorting to the html form at
https://upgrade.awkhad.com
...
* your email address
* the target version (the Awkhad version you want to upgrade to)
* the purpose of your request (test or production)
* the database dump name (required but purely informative)
* optionally the server timezone (for Awkhad source version < 6.1)

The ``create`` method
---------------------

.. py:function:: https://upgrade.awkhad.com/database/v1/create
    ...
    :param str target: (required) the Awkhad version you want to upgrade to. Valid choices: 10.0, 11.0, 12.0
    ...
    :param str timezone: (optional) the timezone used by your server. Only for Awkhad source version < 6.1
...
.. switcher::
    ...
    .. code-block:: python
        ...
        CREATE_URL = "https://upgrade.awkhad.com/database/v1/create"
...
.. py:function:: https://upgrade.awkhad.com/database/v1/upload
...
.. switcher::
    ...
    .. code-block:: python
        ...
        UPLOAD_URL = "https://upgrade.awkhad.com/database/v1/upload"
...
.. py:function:: https://upgrade.awkhad.com/database/v1/request_sftp_access
...
.. switcher::
    ...
    .. code-block:: python
        ...
        UPLOAD_URL = "https://upgrade.awkhad.com/database/v1/request_sftp_access"
    ...
    .. code-block:: bash
        ...
        REQUEST_SFTP_ACCESS_URL="https://upgrade.awkhad.com/database/v1/request_sftp_access"
...
::
    ...
    $ sftp -P 2200 user_10534@upgrade.awkhad.com
    Connected to upgrade.awkhad.com.
...
::
  ...
  echo "put /path/to/openchs.70.cdump openchs.70.cdump" | sftp -b - -P 2200 user_10534@upgrade.awkhad.com
...
.. py:function:: https://upgrade.awkhad.com/database/v1/process
...
.. switcher::
    ...
    .. code-block:: python
        ...
        PROCESS_URL = "https://upgrade.awkhad.com/database/v1/process"
...
If you don't want Awkhad to test and validate the migration, you can bypass the testing stage and directly get the migrated dump.

The ``skip_test`` method
------------------------

.. py:function:: https://upgrade.awkhad.com/database/v1/skip_test
...
.. switcher::
    ...
    .. code-block:: python
        ...
        PROCESS_URL = "https://upgrade.awkhad.com/database/v1/skip_test"
...
.. py:function:: https://upgrade.awkhad.com/database/v1/status
...
.. switcher::
    ...
    .. code-block:: python
        ...
        PROCESS_URL = "https://upgrade.awkhad.com/database/v1/status"
    ...
    .. code-block:: bash
        ...
        STATUS_URL="https://upgrade.awkhad.com/database/v1/status"
        KEY="Aw7pItGVKFuZ_FOR3U8VFQ=="
        REQUEST_ID="10534"
        URL_PARAMS="key=${KEY}&request=${REQUEST_ID}"
...
``target``
    the target Awkhad version you supplied when creating the request
``aim``
...
``issue_stage``
    the stage of the issue we have create on Awkhad main server
``issue``
    the id of the issue we have create on Awkhad main server
``status_url``
...
``database_version``
    the guessed Awkhad version of your uploaded (not upgraded) database
``postgresql``
    ...
    .. code-block:: json

        {
          ...
          "request": {
            ...
            "issue_stage": "new",
            "issue": 648398,
            "status_url": "https://upgrade.awkhad.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/status",
            "notes_url": "https://upgrade.awkhad.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/upgraded/notes",
            "original_sql_url": "https://upgrade.awkhad.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/original/sql",
            "original_dump_url": "https://upgrade.awkhad.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/original/archive",
            "upgraded_sql_url": "https://upgrade.awkhad.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/upgraded/sql",
            "upgraded_dump_url": "https://upgrade.awkhad.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/upgraded/archive",
            "modules_url": "https://upgrade.awkhad.com/database/eu1/10534/Aw7pItGVKFuZ_FOR3U8VFQ==/modules/archive",
            "filesize": "912.99 Kb",
            "database_uuid": null,
