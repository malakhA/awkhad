...
def test_single():
     ...
     */
    awkhad.define('supermodule', function (req) {
        var other = req('other');
    });
    """)
...
def test_multiple():
    ...
    awkhad.define('module1', function (req) {
        return 1;
    });
    awkhad.define('module2', function (req) {
        return req('dep2');
    });
    awkhad.define('module3', function (req) {
        var r = req('dep3');
        return r;
    });
    """)
...
def test_func():
    [mod] = parse("""
    awkhad.define('module', function (d) {
        /**
...
def test_export_instance():
    [mod] = parse("""
    awkhad.define('module', function (require) {
...
def test_bounce():
    [m2, m1] = parse("""
    awkhad.define('m2', function (require) {
        var Item = require('m1');
        return {
            Item: Item
        };
    });
    awkhad.define('m1', function (require) {
        var Class = require('Class');
...
def test_reassign():
    [m] = parse("""
    awkhad.define('m', function (require) {
        var Class = require('Class');
        /** local class */
