# -*- coding: utf-8 -*-
"""
Test various crap patterns found in Awkhad code to ensure they don't blow up
the parser thingie
"""
...
def test_prototype():
    ...
    awkhad.define('mod2', function (require) {
