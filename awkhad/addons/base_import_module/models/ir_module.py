...
from awkhad.tools import convert_file, exception_to_unicode, pycompat
from awkhad.tools.osutil import tempdir
...
class IrModule(models.Model):
    ...
    def _import_module(self, module, path, force=False):
        ...
        if unmet_dependencies:
            ...
            raise UserError(_("Studio customizations require the Awkhad Studio app."))
    ...
    def import_zipfile(self, module_file, force=False):
        ...
        with zipfile.ZipFile(module_file, "r") as z:
            ...
            with tempdir() as module_dir:
                import awkhad.modules.module as module
                try:
