...
import awkhad
from awkhad import api, models, registry
...
from awkhad.osv.expression import FALSE_DOMAIN, OR

from awkhad.addons.base.models.qweb import QWebException
from awkhad.addons.http_routing.models.ir_http import ModelConverter, _guess_mimetype
from awkhad.addons.portal.controllers.portal import _build_url_w_params
...
def get_request_website():
    ...
    ```
    from awkhad.addons.website.models import ir_http
...
class Http(models.AbstractModel):
    ...
    def _handle_exception(cls, exception):
        ...
        if not is_website_request:
            ...
            if isinstance(exception, awkhad.exceptions.AccessError):
                code = 403
            ...
            if isinstance(exception, QWebException):
                ...
                if type(exception.error) == awkhad.exceptions.AccessError:
                    code = 403
