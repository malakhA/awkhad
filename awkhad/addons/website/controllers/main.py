...
from awkhad import http, models, fields, _
from awkhad.http import request
from awkhad.tools import pycompat, OrderedSet
from awkhad.addons.http_routing.models.ir_http import slug, _guess_mimetype
from awkhad.addons.web.controllers.main import Binary
from awkhad.addons.portal.controllers.portal import pager as portal_pager
from awkhad.addons.portal.controllers.web import Home
...
class Website(Home):
    ...
    def website_info(self, **kwargs):
        ...
        values = {
            'apps': apps,
            'modules': modules,
            'version': awkhad.service.common.exp_version()
        }
