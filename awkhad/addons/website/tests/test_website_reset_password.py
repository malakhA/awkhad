...
class TestWebsiteResetPassword(HttpCase):
    ...
    def test_01_website_reset_password_tour(self):
        ...
        # if the send works.
        MailMail = awkhad.addons.mail.models.mail_mail.MailMail
        ...
        MailTemplate = awkhad.addons.mail.models.mail_template.MailTemplate
        ...
        with patch.object(MailMail, 'unlink', lambda self: None), patch.object(MailTemplate, 'send_mail', my_send_mail):
            self.browser_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('website_reset_password')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.website_reset_password.ready", login="admin")
