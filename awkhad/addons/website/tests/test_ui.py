...
@awkhad.tests.tagged('-at_install', 'post_install')
class TestUiCustomizeTheme(awkhad.tests.HttpCase):
...
@awkhad.tests.tagged('-at_install', 'post_install')
class TestUiHtmlEditor(awkhad.tests.HttpCase):
    def test_html_editor_multiple_templates(self):
        ...
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('html_editor_multiple_templates')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.html_editor_multiple_templates.ready", login='admin')
    ...
    def test_html_editor_scss(self):
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('test_html_editor_scss')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.test_html_editor_scss.ready", login='admin')


class TestUiTranslate(awkhad.tests.HttpCase):
    def test_admin_tour_rte_translator(self):
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('rte_translator')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.rte_translator.ready", login='admin', timeout=120)
...
class TestUi(awkhad.tests.HttpCase):
    ...
    def test_01_public_homepage(self):
        self.phantom_js("/", "console.log('ok')", "'website.content.snippets.animation' in awkhad.__DEBUG__.services")

    def test_02_admin_tour_banner(self):
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('banner')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.banner.ready", login='admin')
