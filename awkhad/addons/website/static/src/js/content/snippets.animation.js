awkhad.define('website.content.snippets.animation', function (require) {
'use strict';
...
registry.mediaVideo = Animation.extend({
    ...
    start: function () {
        ...
        // integrated with Awkhad (this refactoring should be done in master).
 ...
 *
 * This should be removed in a future awkhad snippets refactoring.
 */
