awkhad.define('website.seo', function (require) {
'use strict';
...
var MetaImageSelector = Widget.extend({
    ...
    init: function (parent, data) {
        ...
        data.pageImages.unshift(_.str.sprintf('/web/image/res.company/%s/logo', awkhad.session_info.website_company_id));
        data.pageImages.unshift(_.str.sprintf('/web/image/website/%s/social_default_image', awkhad.session_info.website_id));
