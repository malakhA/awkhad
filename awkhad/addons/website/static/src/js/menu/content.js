awkhad.define('website.contentMenu', function (require) {
'use strict';
...
var PagePropertiesDialog = weWidgets.Dialog.extend({
     ...
     * to a string representing UTC in Awkhad's datetime string format
     * (exemple: '2018-04-22 13:12:35').
     *
     * The time zone of the datetime string is assumed to be the one of the
     * browser and it will be converted to UTC (standard for Awkhad).
     *
     * @private
