...
To: {to}
cc: {cc}
Received: by mail1.zgui.com (Postfix, from userid 10002)
...
Received: from mail-ie0-f173.google.com (mail-ie0-f173.google.com [209.85.223.173])
    ...
    for <raoul@zgui.fr>; Fri, 23 Aug 2013 13:17:55 +0200 (CEST)
...
From: Anon <anon@awkhad.com>
To: anon@gmail.com
References: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@awkhad.com>
Message-ID: <cb7eaf62-58dc-2017-148c-305d0c78892f@awkhad.com>
Date: Wed, 14 Mar 2018 14:26:58 +0100
User-Agent: Mozilla/5.0 (X11; Linux x86_64; rv:52.0) Gecko/20100101
 Thunderbird/52.6.0
MIME-Version: 1.0
In-Reply-To: <f3b9f8f8-28fa-2543-cab2-7aa68f679ebb@awkhad.com>
Content-Type: multipart/mixed;
...
Delivered-To: anon2@gmail1.zgui.com
...
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@awkhad.com header.s=mail header.b=MCzhjB9b;
       spf=pass (google.com: domain of soup@awkhad.com designates 149.202.180.44 as permitted sender) smtp.mailfrom=soup@awkhad.com;
       dmarc=pass (p=NONE sp=NONE dis=NONE) header.from=awkhad.com
Return-Path: <soup@awkhad.com>
Received: from mail2.awkhad.com (mail2.awkhad.com. [149.202.180.44])
        by mx.google.com with ESMTPS id y4si4279200wmy.148.2018.03.05.01.19.22
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Mon, 05 Mar 2018 01:19:23 -0800 (PST)
Received-SPF: pass (google.com: domain of soup@awkhad.com designates 149.202.180.44 as permitted sender) client-ip=149.202.180.44;
...
Received: from [10.10.31.24] (unknown [91.183.114.50])
	...
	by mail2.awkhad.com (Postfix) with ESMTPSA id 7B571A4085
	for <what@awkhad.com>; Mon,  5 Mar 2018 10:19:21 +0100 (CET)
DKIM-Signature: v=1; a=rsa-sha256; c=simple/simple; d=awkhad.com; s=mail;
...
To: what@awkhad.com
From: Soup <soup@awkhad.com>
Subject: =?UTF-8?Q?Soupe_du_jour_:_Pois_cass=c3=a9s?=
Message-ID: <a05d8334-7b7c-df68-c96a-4a88ed19f31b@awkhad.com>
...
X-Spam-Checker-Version: SpamAssassin 3.4.0 (2014-02-07) on mail2.awkhad.com
...
Chaussée de Namur, 40
B-1367 Grand Rosière
Web: <a class="moz-txt-link-freetext" href="http://www.awkhad.com">http://www.awkhad.com</a> </pre>
  </body>
</html>
...
In-Reply-To: <829228111124527.1111111602.256611118262939-zgui-129-xxxx.xxxx@ip-1-1-1-1>
References: <867911111953277.1523671337.187951111160400-zgui-129-xxxx.xxxx@ip-1-1-1-1>
 <867911111953277.1523671337.256611118262939-zgui-129-xxxx.xxxx@ip-1-1-1-1>
...
.256660938262939-zgui-129-xxxx.xxxx@ip-1-1-1-1" type=3D"cite"=
 class=3D"cite2">
...
"0" bgcolor=3D"#99d8ff" style=3D"min-width: 590px; background-color: rgb(13=
...
.com" style=3D"text-decoration:none; color: white;">
                      ...
                      <tr>
                        <td align=3D"center">
                            Powered by <a href=3D"https://www.awkhad.com">Odo=
o</a>.
                        </td>
                      </tr>
                    </tbody>
