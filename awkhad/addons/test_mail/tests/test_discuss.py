...
from awkhad.addons.test_mail.tests.common import BaseFunctionalTest, TestRecipients, MockEmails
...
class TestNotifications(BaseFunctionalTest, MockEmails):
    ...
    def test_inactive_follower(self):
        # In some case awkhadbot is follower of a record.
        # Even if it shouldn't be the case, we want to be sure that awkhadbot is not notified
