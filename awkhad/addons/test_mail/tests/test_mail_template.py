...
from awkhad.tools import mute_logger, DEFAULT_SERVER_DATETIME_FORMAT
...
class TestMailTemplate(BaseFunctionalTest, MockEmails, TestRecipients):
    ...
    #     with patch('awkhad.addons.mail.tests.test_mail_template.datetime', wraps=datetime) as mock_datetime:
    ...
    def test_create_partner_from_tracking_multicompany(self):
        ...
        with patch('awkhad.addons.mail.models.mail_thread.MailThread._message_track_post_template', patched_message_track_post_template):
