...
from awkhad.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE_PLAINTEXT
from awkhad.addons.test_mail.models.test_mail_models import MailTestSimple
...
class TestMessagePost(BaseFunctionalTest, MockEmails, TestRecipients):
    ...
    def test_post_answer(self):
        ...
        self.assertEmails(self.user_employee.partner_id, [[self.partner_1]], ref_content='zgui-%d-mail.test.simple' % self.test_record.id)
        # self.assertTrue(all('zgui-%d-mail.test.simple' % self.test_record.id in m['references'] for m in self._mails))
    ...
    @mute_logger('awkhad.addons.mail.models.mail_mail', 'awkhad.addons.mail.models.mail_thread')
