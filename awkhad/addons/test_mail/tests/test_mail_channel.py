...
from awkhad.addons.test_mail.tests import common
from awkhad.addons.test_mail.tests.common import mail_new_test_user
from awkhad.exceptions import AccessError, except_orm, ValidationError, UserError
...
class TestChannelAccessRights(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('awkhad.addons.base.models.ir_model', 'awkhad.models')
    ...
    @mute_logger('awkhad.addons.base.models.ir_model', 'awkhad.models', 'awkhad.models.unlink')
...
class TestChannelFeatures(common.BaseFunctionalTest, common.MockEmails):
    ...
    @mute_logger('awkhad.addons.mail.models.mail_mail', 'awkhad.models.unlink')
...
class TestChannelModeration(common.Moderation):
    ...
    @mute_logger('awkhad.addons.mail.models.mail_channel', 'awkhad.models.unlink')
    ...
    @mute_logger('awkhad.models.unlink')
