...
from awkhad.tools import float_compare, float_round, float_is_zero, pycompat
...
class StockMove(models.Model):
    ...
    def _account_entry_move(self):
        ...
        if self.company_id.anglo_saxon_accounting:
            # Creates an account entry from stock_input to stock_output on a dropship move. https://github.com/awkhad/awkhad/issues/12687
            journal_id, acc_src, acc_dest, acc_valuation = self._get_accounting_data_for_valuation()
