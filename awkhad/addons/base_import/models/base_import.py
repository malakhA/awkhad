...
from awkhad.tools import config, DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, pycompat
...
class ImportMapping(models.Model):
    ...
    not match Awkhad's field names or labels. This model is used
    ...
    def get_fields(self, model, depth=FIELDS_RECURSION_LIMIT):
        ...
        .. class:: Field
            ...
            .. attribute:: name (str)
                ...
                The field's logical (Awkhad) name within the scope of
                its parent.
