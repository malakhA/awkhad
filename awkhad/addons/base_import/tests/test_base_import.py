...
from awkhad.tests.common import TransactionCase, can_import
from awkhad.modules.module import get_module_resource
from awkhad.tools import mute_logger, pycompat
...
class TestPreview(TransactionCase):
    ...
    @mute_logger('awkhad.addons.base_import.models.base_import')
