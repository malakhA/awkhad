...
if (_.contains(awkhad._modules, 'sale_management')) {
    deps.push('sale.product_configurator_tour');
    deps.push('sale.product_configurator_pricelist_tour');
}

awkhad.define("sale_stock.tour", deps, function (require) {
    "use strict";

    var tour = require('web_tour.tour');

    if (_.has(awkhad.__DEBUG__.services, 'sale.product_configurator_tour')) {
    ...
    if (_.has(awkhad.__DEBUG__.services, 'sale.product_configurator_pricelist_tour')) {
