...
Also, adds methods to convert values back to Awkhad models.
"""
...
from awkhad.tools import html_escape as escape
from awkhad.addons.base.models import ir_qweb
...
class Image(models.AbstractModel):
    ...
    def load_local_url(self, url):
        ...
        path = awkhad.modules.get_module_resource(
