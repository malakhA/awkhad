awkhad.define('web_editor.web_editor_tests', function (require) {
"use strict";
    ...
    var form = testUtils.createView({
        ...
        mockRPC: function (route, args) {
            ...
            if (_.str.startsWith(route, '/logo')) {
                ...
                window.awkhad[$.deparam(route).callback + '_content'].call();
                return $.when();
            }
            return this._super.apply(this, arguments);
        },
    ...
    var form = testUtils.createView({
        ...
        mockRPC: function (route, args) {
            ...
            if (_.str.startsWith(route, '/logo')) {
                ...
                window.awkhad[$.deparam(route).callback + '_content']();
                return $.when();
            }
            return this._super.apply(this, arguments);
        },
        ...
        mockRPC: function (route, args) {
            ...
            if (_.str.startsWith(route, '/logo')) {
                ...
                return loadDeferred.then(function () {
                    var contentCallback = window.awkhad[callback + '_content'];
                    var editorCallback = window.awkhad[callback + '_editor'];
