awkhad.define('web_editor.rte', function (require) {
'use strict';
...
var RTEWidget = Widget.extend({
    ...
    start: function () {
        ...
        .each(function () {
            ...
            // fallback for firefox iframe display:none see https://github.com/awkhad/awkhad/pull/22610
...
awkhad.define('web_editor.rte.summernote_custom_colors', function (require) {
'use strict';
