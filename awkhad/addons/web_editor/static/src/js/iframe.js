awkhad.define('web_editor.iframe', function (require) {
'use strict';
...
window.top.awkhad[callback + '_updown'] = function (value, fields_values, field_name) {
...
editor.Class.include({
    start: function () {
        this.on('rte:start', this, function () {
            ...
            if (window.top.awkhad[callback + '_editor']) {
                window.top.awkhad[callback + '_editor'](this);
            }
            ...
            $editable.on('content_changed', this, function () {
                if (window.top.awkhad[callback + '_downup']) {
                    window.top.awkhad[callback + '_downup']($editable.prop('innerHTML'));
                }
            });
        });
...
awkhad.define('root.widget', function (require) {
'use strict';
...
awkhad.define('web_editor.IframeRoot', function (require) {
'use strict';
