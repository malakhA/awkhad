define([
  ...
  var Editor = function (handler) {
    ...
    this.style = style;   // AWKHAD: allow access for override
    this.table = table;   // AWKHAD: allow access for override
    this.typing = typing; // AWKHAD: allow access for override
    this.bullet = bullet; // AWKHAD: allow access for override
    ...
    this.saveRange = function ($editable, thenCollapse) {
      // AWKHAD: scroll to top when click on input in editable m (start_modification
      // this.focus($editable);
      var r = range.create();
      if (!r || ($editable[0] !== r.sc && !$.contains($editable[0], r.sc))) {
        $editable.focus();
      }
      // AWKHAD: end_modication)
    ...
    this.createLink = function ($editable, linkInfo, options) {
      ...
      var anchors = [];
      // AWKHAD: adding this branch to modify existing anchor if it fully contains the range
      ...
      $.each(anchors, function (idx, anchor) {
        ...
        $(anchor).attr('class', linkInfo.className || null); // AWKHAD: addition
        $(anchor).css(linkInfo.style || {}); // AWKHAD: addition
        if (isNewWindow) {
