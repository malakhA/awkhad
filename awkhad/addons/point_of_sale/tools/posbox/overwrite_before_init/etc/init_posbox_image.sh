...
mkdir /var/log/awkhad
chown pi:pi /var/log/awkhad
chown pi:pi -R /home/pi/awkhad/
...
echo "* * * * * rm /var/run/awkhad/sessions/*" | crontab -
...
mkdir /home/pi/awkhad/addons/hw_drivers/drivers/
chmod 777 /home/pi/awkhad/addons/hw_drivers/drivers/
echo "addons/hw_drivers/drivers/" > /home/pi/awkhad/.git/info/exclude
