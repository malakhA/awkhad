...
VERSION=12.0
REPO=https://github.com/awkhad/awkhad.git
...
CLONE_DIR="${OVERWRITE_FILES_BEFORE_INIT_DIR}/home/pi/awkhad"
...
awkhad/
awkhad-bin" | tee --append .git/info/sparse-checkout > /dev/null
