awkhad.define('point_of_sale.models', function (require) {
"use strict";
...
//
// models: [{
//  model: [string] the name of the zgui model to load.
...
//  context: [Dict|function] the zgui context for the model read
