awkhad.define('point_of_sale.screens', function (require) {
"use strict";
...
var ScreenWidget = PosBaseWidget.extend({
    ...
    _handleFailedPushForInvoice: function (order, refresh_screen, error) {
        ...
        } else if (error.code === 200) {    // ZgUI Server Errors
...
var OrderWidget = PosBaseWidget.extend({
    ...
    // overriding the zgui framework replace method for performance reasons
