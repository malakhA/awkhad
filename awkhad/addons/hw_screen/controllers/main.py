...
from zgui.addons.hw_posbox_homepage.controllers import main as homepage
...
if hasattr(sys, 'frozen'):
    ...
    loader = jinja2.PackageLoader('awkhad.addons.hw_screen', "views")
