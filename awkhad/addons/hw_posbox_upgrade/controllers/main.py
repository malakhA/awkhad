...
if hasattr(sys, 'frozen'):
    ...
    loader = jinja2.PackageLoader('awkhad.addons.hw_posbox_upgrade', "views")
...
class PosboxUpgrader(hw_proxy.Proxy):
    ...
    def upgrade(self):
        commit = subprocess.check_output("git --work-tree=/home/pi/awkhad/ --git-dir=/home/pi/awkhad/.git log -1", shell=True).decode('utf-8').replace("\n", "<br/>")
        return upgrade_page_template.render({
            'title': "Awkhad's IoTBox - Software Upgrade",
    ...
    def perform_upgrade(self):
        ...
        os.system('/home/pi/awkhad/addons/point_of_sale/tools/posbox/configuration/posbox_update.sh')
