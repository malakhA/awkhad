...
class TestWebsiteSaleZoom(awkhad.tests.HttpCase):
    ...
    def test_01_admin_shop_zoom_tour(self):
        ...
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('shop_zoom')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.shop_zoom.ready", login="admin")
