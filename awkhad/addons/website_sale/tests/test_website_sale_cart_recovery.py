...
class TestWebsiteSaleCartRecovery(HttpCase):
    ...
    def test_01_shop_cart_recovery_tour(self):
        ...
        self.browser_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('shop_cart_recovery')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.shop_cart_recovery.ready", login="portal")
