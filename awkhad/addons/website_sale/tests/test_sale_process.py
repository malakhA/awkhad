...
from awkhad.addons.website.tools import MockRequest


@awkhad.tests.tagged('post_install', '-at_install')
class TestUi(awkhad.tests.HttpCase):
    def test_01_admin_shop_tour(self):
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('shop')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.shop.ready", login="admin")

    def test_02_admin_checkout(self):
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('shop_buy_product')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.shop_buy_product.ready", login="admin")

    def test_03_demo_checkout(self):
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('shop_buy_product')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.shop_buy_product.ready", login="demo")


@awkhad.tests.tagged('post_install', '-at_install')
class TestWebsiteSaleCheckoutAddress(awkhad.tests.TransactionCase):
