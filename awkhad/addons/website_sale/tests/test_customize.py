...
class TestUi(awkhad.tests.HttpCase):
    ...
    def test_01_admin_shop_customize_tour(self):
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('shop_customize')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.shop_customize.ready", login="admin")
    ...
    def test_02_admin_shop_custom_attribute_value_tour(self):
        ...
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('shop_custom_attribute_value')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.shop_custom_attribute_value.ready", login="admin")
    ...
    def test_03_public_tour_shop_dynamic_variants(self):
        ...
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('tour_shop_dynamic_variants')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.tour_shop_dynamic_variants.ready")
    ...
    def test_04_portal_tour_deleted_archived_variants(self):
        ...
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('tour_shop_deleted_archived_variants')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.tour_shop_deleted_archived_variants.ready", login="portal")
    ...
    def test_05_demo_tour_no_variant_attribute(self):
        ...
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('tour_shop_no_variant_attribute')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.tour_shop_no_variant_attribute.ready", login="demo")

    def test_06_admin_list_view_b2c(self):
        self.browser_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('shop_list_view_b2c')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.shop_list_view_b2c.ready", login="admin")
