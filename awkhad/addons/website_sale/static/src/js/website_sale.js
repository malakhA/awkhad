awkhad.define('website_sale.cart', function (require) {
'use strict';
...
awkhad.define('website_sale.website_sale_category', function (require) {
'use strict';
...
awkhad.define('website_sale.website_sale', function (require) {
'use strict';
...
sAnimations.registry.WebsiteSale = sAnimations.Class.extend(ProductConfiguratorMixin, {
            ...
            _.each($('.ecom-zoomable img[data-zoom]'), function (el) {
                onImageLoaded(el, function () {
                    ...
                    if (!_.str.endsWith(el.src, el.dataset.zoomImage) || // if zoom-img != img
                        ...
                        $img.zoomAwkhad({event: autoZoom ? 'mouseenter' : 'click', attach: attach});
    ...
    _updateProductImage: function ($productContainer, productId, productTemplateId, new_carousel, isCombinationPossible) {
        ...
        if (new_carousel) {
            ...
            if ($img.data('zoomAwkhad') !== undefined) {
                $img.data('zoomAwkhad').isReady = false;
            }
        }
