...
from awkhad import api, fields, models, _, SUPERUSER_ID
from awkhad.osv import expression
from awkhad.tools import DEFAULT_SERVER_DATETIME_FORMAT
from awkhad.tools.float_utils import float_compare, float_is_zero, float_round
from awkhad.exceptions import UserError
from awkhad.addons.stock.models.stock_move import PROCUREMENT_PRIORITIES
...
class PickingType(models.Model):
    ...
    show_reserved = fields.Boolean(
        'Show Reserved', default=True, help="If this checkbox is ticked, Awkhad will show which products are reserved (lot/serial number, source location, source package).")
