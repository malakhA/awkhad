...
from awkhad.addons.payment_adyen.controllers.main import AdyenController
from awkhad.tools.pycompat import to_native
...
class AcquirerAdyen(models.Model):
    ...
    def _adyen_generate_merchant_sig_sha256(self, inout, values):
        ...
        :param string inout: 'in' (awkhad contacting ogone) or 'out' (adyen
