...
class base_automation_test(common.TransactionCase):
    ...
    def test_11b_recomputed_field(self):
        ...
        patchers = [
            patch('awkhad.addons.base_automation.models.base_automation.BaseAutomation._get_actions', _patched_get_actions),
            patch('awkhad.addons.mail.models.mail_template.MailTemplate.send_mail', _patched_send_mail),
        ]
