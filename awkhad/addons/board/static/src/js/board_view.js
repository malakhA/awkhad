awkhad.define('board.BoardView', function (require) {
"use strict";
    ...
    _createController: function (params) {
        ...
        return this._rpc({
            ...
            .then(function (action) {
                ...
                // override the https://github.com/awkhad/awkhad/pull/28408language to take the current one
...
awkhad.define('board.viewRegistry', function (require) {
"use strict";
