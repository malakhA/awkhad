...
from awkhad import api, fields, models, tools, _, SUPERUSER_ID
...
class MassMailingList(models.Model):
    ...
    def action_merge(self, src_lists, archive):
        ...
        # A (id=4): yti@awkhad.com; yti@example.com
        # B (id=5): yti@awkhad.com; yti@zgui.com
        # C (id=6): nothing
        ...
        # ------------+---------------------------+------------------------
        #           4 | yti@awkhad.com              |          1 |        4 |
        #           6 | yti@awkhad.com              |          2 |        5 |
...
class MassMailing(models.Model):
    ...
    mail_server_id = fields.Many2one('ir.mail_server', string='Mail Server',
        ...
        help="Use a specific mail server in priority. Otherwise Awkhad relies on the first outgoing mail server available (based on their sequencing) as it does for normal mails.")
