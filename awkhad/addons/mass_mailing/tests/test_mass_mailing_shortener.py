...
class TestMassMailingShortener(common.TransactionCase):
    ...
    def setUp(self):
        ...
        patcher = patch('awkhad.addons.link_tracker.models.link_tracker.link_tracker._compute_favicon', wraps=_compute_favicon)
        patcher2 = patch('awkhad.addons.link_tracker.models.link_tracker.link_tracker._get_title_from_url', wraps=_get_title_from_url)
        patcher.start()
        patcher2.start()
    ...
    def test_00_test_mass_mailing_shortener(self):
        ...
        mass_mailing = self.env['mail.mass_mailing'].create({
            ...
            "body_html": """
Hi,
% set url = "www.awkhad.com"
% set httpurl = "https://www.awkhad.eu"
Website0: <a id="url0" href="https://www.awkhad.tz/my/${object.name}">https://www.awkhad.tz/my/${object.name}</h1>
Website1: <a id="url1" href="https://www.awkhad.be">https://www.awkhad.be</h1>
Website2: <a id="url2" href="https://${url}">https://${url}</h1>
Website3: <a id="url3" href="${httpurl}">${httpurl}</h1>
Email: <a id="url4" href="mailto:test@awkhad.com">test@awkhad.com</h1>
            """,
            "schedule_date": False,
            "state": "draft",
            "keep_archives": True,
        ...
        self.assertEqual(after_url4, "mailto:test@awkhad.com", 'mailto: has been converted')
        ...
        self.assertTrue("https://www.awkhad.tz/my/User" in short0.url, 'URL mismatch')
        self.assertEqual(short1.url, "https://www.awkhad.be", 'URL mismatch')
        self.assertEqual(short2.url, "https://www.awkhad.com", 'URL mismatch')
        self.assertEqual(short3.url, "https://www.awkhad.eu", 'URL mismatch')
        ...
        self.assertEqual(_after_url4, "mailto:test@awkhad.com", 'mailto: has been converted')
        ...
        self.assertTrue("https://www.awkhad.tz/my/User" in _short0.url, 'URL mismatch')
        self.assertEqual(_short1.url, "https://www.awkhad.be", 'URL mismatch')
        self.assertEqual(_short2.url, "https://www.awkhad.com", 'URL mismatch')
        self.assertEqual(_short3.url, "https://www.awkhad.eu", 'URL mismatch')
