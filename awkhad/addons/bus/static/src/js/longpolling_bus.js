awkhad.define('bus.Longpolling', function (require) {
"use strict";
...
var LongpollingBus = Bus.extend(ServicesMixin, {
    ...
    /**
     * Tell whether awkhad is focused or not
     *
     * @returns {boolean}
     */
    isAwkhadFocused: function () {
        return this._isAwkhadFocused;
    },
    /**
    ...
    _onFocusChange: function (params) {
        this._isAwkhadFocused = params.focus;
        if (params.focus) {
            this._lastPresenceTime = new Date().getTime();
