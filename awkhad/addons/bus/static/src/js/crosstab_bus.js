awkhad.define('bus.CrossTab', function (require) {
"use strict";
 ...
 * - {LACAL_STORAGE_PREFIX}.{sanitizedOrigin}.channels : shared public channel list to listen during the poll
 * - {LACAL_STORAGE_PREFIX}.{sanitizedOrigin}.options : shared options
 * - {LACAL_STORAGE_PREFIX}.{sanitizedOrigin}.notification : the received notifications from the last poll
 * - {LACAL_STORAGE_PREFIX}.{sanitizedOrigin}.tab_list : list of opened tab ids
 * - {LACAL_STORAGE_PREFIX}.{sanitizedOrigin}.tab_master : generated id of the master tab
 *
 * trigger:
...
var CrossTabBus = Longpolling.extend({
    ...
    init: function () {
        ...
        this._id = _.uniqueId(this.LACAL_STORAGE_PREFIX) + ':' + now;
    ...
    /**
     * Generates localStorage keys prefixed by bus. (LACAL_STORAGE_PREFIX = the name
    ...
    _generateKey: function (key) {
        return this.LACAL_STORAGE_PREFIX + '.' + this._sanitizedOrigin + '.' + key;
    },
    /**
     * @override
    ...
    _onStorage: function (e) {
        ...
        // update focus
            ...
            this._isAwkhadFocused = value;
            this.trigger('window_focus', this._isAwkhadFocused);
        }
    },
    /**
