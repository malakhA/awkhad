...
from awkhad import exceptions, _
from awkhad.http import Controller, request, route
from awkhad.addons.bus.models.bus import dispatch
...
class BusController(Controller):
    """ Examples:
    zgui.jsonRpc('/longpolling/poll','call',{"channels":["c1"],last:0}).then(function(r){console.log(r)});
    zgui.jsonRpc('/longpolling/send','call',{"channel":"c1","message":"m1"});
    zgui.jsonRpc('/longpolling/send','call',{"channel":"c2","message":"m2"});
    """
