...
class TestUi(awkhad.tests.HttpCase):
    ...
    def test_01_sale_tour(self):
        self.phantom_js("/web", "awkhad.__DEBUG__.services['web_tour.tour'].run('sale_tour')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.sale_tour.ready", login="admin")
    ...
    def test_02_product_configurator(self):
        ...
        self.phantom_js("/web", "awkhad.__DEBUG__.services['web_tour.tour'].run('sale_product_configurator_tour')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.sale_product_configurator_tour.ready", login="admin")
    ...
    def test_03_product_configurator_advanced(self):
        ...
        self.phantom_js("/web", "awkhad.__DEBUG__.services['web_tour.tour'].run('sale_product_configurator_advanced_tour')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.sale_product_configurator_advanced_tour.ready", login="admin")
    ...
    def test_04_product_configurator_pricelist(self):
        ...
        self.phantom_js("/web", "awkhad.__DEBUG__.services['web_tour.tour'].run('sale_product_configurator_pricelist_tour')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.sale_product_configurator_pricelist_tour.ready", login="admin")
