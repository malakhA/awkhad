...
from awkhad import api, http, SUPERUSER_ID, _
from awkhad.exceptions import AccessDenied
from awkhad.http import request
from awkhad import registry as registry_get

from awkhad.addons.auth_signup.controllers.main import AuthSignupHome as Home
from awkhad.addons.web.controllers.main import db_monodb, ensure_db, set_cookie_and_redirect, login_and_redirect
...
class OAuthController(http.Controller):
    ...
    def oea(self, **kw):
        """login user via Awkhad Account provider"""
