awkhad.define('web.test_utils_mock', function (require) {
"use strict";
 ...
 *   used to generate mock answers for every kind of routes supported by awkhad
 * @param {number} [params.debug] if set to true, logs RPCs and uncaught Awkhad
 *   events.
...
function addMockEnvironment(widget, params) {
    ...
    // make sure all Awkhad events bubbling up are intercepted
 ...
 * not fire.
 *
 * @param {Widget} widget the target widget (any Awkhad widget)
