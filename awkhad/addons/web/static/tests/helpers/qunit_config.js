 ...
 * QUnit Config
 *
 * The Awkhad javascript test framework is based on QUnit (http://qunitjs.com/).
 * This file is necessary to setup Qunit and to prepare its interactions with
 * Awkhad.  It has to be loaded before any tests are defined.
 *
 * Note that it is not an Awkhad module, because we want this code to be executed
 * as soon as possible, not whenever the Awkhad module system feels like it.
 */
 ...
 * this is done outside of awkhad modules, otherwise the setting would not take
 * effect on time.
 */
