awkhad.define('web.search_inputs', function (require) {
"use strict";
...
/**
 * Implementation of the ``char`` ZgUI field type:
 *
...
/**
 * Implementation of the ``datetime`` zgui field type:
 *
...
var FilterGroup = Input.extend(/** @lends instance.web.search.FilterGroup# */{
     ...
     *
     * @param {zgui.web.search.Facet} facet
...
var Filter = Input.extend(/** @lends instance.web.search.Filter# */{
    ...
    /**
     * Implementation of the ZgUI filters (button with a context and/or
