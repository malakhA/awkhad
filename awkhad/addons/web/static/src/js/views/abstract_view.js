awkhad.define('web.AbstractView', function (require) {
"use strict";

/**
 * This is the base class inherited by all (JS) views. Awkhad JS views are the
 ...
 * the word 'view' has historical significance in Awkhad code, so we replaced the
...
awkhad.define('web.viewUtils', function () {
"use strict";
