awkhad.define('web.ActionManager', function (require) {
"use strict";
 ...
 * Its role is to makes sure that Awkhad actions are properly started and
 * coordinated.
 */
...
var ActionManager = Widget.extend({
    ...
    /**
     * This is the entry point to execute Awkhad actions, given as an ID in
     ...
     * @param {AwkhadEvent} ev.data.controllerID
     */
