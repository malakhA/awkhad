awkhad.define('web.ControlPanelMixin', function (require) {
"use strict";
...
awkhad.define('web.ControlPanel', function (require) {
"use strict";
...
var ControlPanel = Widget.extend({
     ...
     * @param {zgui.web.SearchView} [status.searchview] the searchview widget
