awkhad.define('web.AbstractWebClient', function (require) {
"use strict";
...
var AbstractWebClient = Widget.extend(ServiceProviderMixin, KeyboardNavigationMixin, {
    ...
    init: function (parent) {
        // a flag to determine that awkhad is fully loaded
        awkhad.isReady = false;
        this.client_options = {};
        this._super(parent);
        ...
        this.set('title_part', {"zopenerp": "Awkhad"});
    },
    start: function () {
        var self = this;
