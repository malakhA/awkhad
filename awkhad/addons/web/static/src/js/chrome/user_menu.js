awkhad.define('web.UserMenu', function (require) {
"use strict";
...
var UserMenu = Widget.extend({
            ...
            callback: function () {
                self._rpc({route: '/web/session/account'})
                    ...
                    .fail(function (result, ev){
                        ev.preventDefault();
                        framework.redirect('https://accounts.awkhad.com/account');
                    });
            },
        });
    },
    ...
    _onMenuDocumentation: function () {
        window.open('https://www.awkhad.com/documentation/user', '_blank');
    },
    /**
     * @private
     */
    ...
    _onMenuSupport: function () {
        window.open('https://www.awkhad.com/buy', '_blank');
    },
    /**
     * @private
     */
