awkhad.define('web.CrashManager', function (require) {
"use strict";
...
var CrashManager = core.Class.extend({
    ...
    show_warning: function(error) {
        ...
        return new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type || error.message) || _t("Awkhad Warning"),
    ...
    show_error: function(error) {
        ...
        var dialog = new Dialog(this, {
            title: _.str.capitalize(error.type || error.message) || _t("Awkhad Error"),
...
var RedirectWarningHandler = Dialog.extend(ExceptionHandler, {
    ...
    display: function() {
        ...
        new Dialog(this, {
            size: 'medium',
            title: _.str.capitalize(error.type) || _t("Awkhad Warning"),
            buttons: [
...
core.crash_registry.add('awkhad.exceptions.RedirectWarning', RedirectWarningHandler);

function session_expired(cm) {
    return {
        display: function () {
            cm.show_warning({type: _t("Awkhad Session Expired"), data: {message: _t("Your Awkhad session expired. Please refresh the current web page.")}});
        }
    }
}
core.crash_registry.add('awkhad.http.SessionExpiredException', session_expired);
...
awkhad.define('web.crash_manager', function (require) {
"use strict";
