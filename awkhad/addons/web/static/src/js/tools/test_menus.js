(function (exports) {
    ...
    function createWebClientHooks() {
        var AbstractController = awkhad.__DEBUG__.services['web.AbstractController'];
        var Discuss = awkhad.__DEBUG__.services['mail.Discuss'];
        var WebClient = awkhad.__DEBUG__.services["web.WebClient"];
