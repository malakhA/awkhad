awkhad.define('web.framework', function (require) {
"use strict";
...
if ($.blockUI) {
    ...
    $.blockUI.defaults.message = '<div class="zgui oe_blockui_spin_container" style="background-color: transparent;">';
...
//  * If params.wait, reload will wait the zgui server to be reachable before reloading
