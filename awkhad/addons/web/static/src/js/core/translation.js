...
awkhad.define('web.translation', function (require) {
"use strict";
...
var TranslationDataBase = Class.extend(/** @lends instance.TranslationDataBase# */{
    ...
    /**
        Loads the translations from an ZgUI server.

        @param {zgui.Session} session The session object to contact the server.
