awkhad.define('web.concurrency', function (require) {
"use strict";
 ...
 * everything concurrency related in Awkhad.
 *
 * The basic concurrency primitives in Awkhad JS are the callback, and the
...
return {
    ...
    /**
     * A (Awkhad) mutex is a primitive for serializing computations.  This is
