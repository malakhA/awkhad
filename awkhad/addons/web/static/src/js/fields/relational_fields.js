awkhad.define('web.relational_fields', function (require) {
"use strict";
...
var FieldMany2One = AbstractField.extend({
    ...
    */
     ...
     *
     * @param {AwkhadEvent} event 'field_changed' event
     */
...
var FieldX2Many = AbstractField.extend({
     ...
     * @override
     * @param {Object} record
     * @param {AwkhadEvent} [ev] an event that triggered the reset action
...
var FieldOne2Many = FieldX2Many.extend({
     ...
     * @override
     * @private
     * @param {AwkhadEvent|MouseEvent} ev this event comes either from the 'Add
