...
:js:class:`zgui.web.list.Column` objects allowing for the
...
.. js:class:: zgui.web.list.Column(id, tag, attrs)

    .. js:function:: zgui.web.list.Column.format(record_data, options)
        ...
        Otherwise calls :js:func:`~zgui.web.list.Column._format`
        ...
        :js:func:`~zgui.web.list.Column._format` instead.

        :returns: String

    .. js:function:: zgui.web.list.Column._format(record_data, options)

        Never called directly, called if the column is visible and has
        a value.

        The default implementation calls
        :js:func:`~zgui.web.format_value` and htmlescapes the
        result (via ``_.escape``).

        Note that the implementation of
        :js:func:`~zgui.web.list.Column._format` *must* escape the
        data provided to it, its output will *not* be escaped by
        :js:func:`~zgui.web.list.Column.format`.
...
:js:func:`~zgui.web.ListView.editable` method, will return a falsy
...
``context.set_editable``
    ...
    :js:func:`~zgui.web.ListView.do_search`` handler), ``true``
...
.. js:function:: zgui.web.ListView.ensure_saved
...
.. js:function:: zgui.web.ListView.start_edition([record][, options])
    ...
    :type record: :js:class:`~zgui.web.list.Record`
    :param EditOptions options:
    :returns: delegate to the form used for the edition

.. js:function:: zgui.web.ListView.save_edition
...
.. js:function:: zgui.web.ListView.cancel_edition([force=false])
...
.. js:function:: zgui.web.ListView.get_cells_for(row)
...
.. js:function:: zgui.web.ListView.with_event(event_name, event, action[, args][, trigger_params])
...
.. js:function:: zgui.web.ListView.handle_onwrite(record)
    ...
    :param record: record being written having triggered the
                   ``onwrite`` callback
    :type record: zgui.web.list.Record
...
:js:class:`~zgui.web.list.Editor`.

.. js:class:: zgui.web.list.Editor(parent[, options])
    ...
    e.g. :js:func:`~zgui.web.list.Editor.edit` multiple times in a
    row without saving or cancelling each edit is undefined.

    :param parent:
    :type parent: :js:class:`~zgui.web.Widget`
    :param EditorOptions options:

    .. js:function:: zgui.web.list.Editor.is_editing([record_state])
    ...
    .. js:function:: zgui.web.list.Editor.edit(record, configureField[, options])
        ...
        :type configureField: Function<String, zgui.web.form.Field>
        :param EditOptions options:
        :returns: jQuery delegate to the form object

    .. js:function:: zgui.web.list.Editor.save
    ...
    .. js:function:: zgui.web.list.Editor.cancel([force=false])
...
.. js:class:: EditorOptions
    ...
    .. js:attribute:: EditorOptions.formView
        ...
        By default, :js:class:`~zgui.web.FormView`
...
.. js:class:: EditorDelegate
    ...
    the :js:class:`~zgui.web.list.Editor`'s delegate.
    ...
    .. js:function:: EditorDelegate.edition_view(editor)
        ...
        Called by the :js:class:`~zgui.web.list.Editor` object to
        ...
        :type editor: :js:class:`~zgui.web.list.Editor`
        :returns: form view
        :rtype: Object

    .. js:function:: EditorDelegate.prepends_on_create

        By default, the :js:class:`~zgui.web.list.Editor` will
...
* The editable listview behavior has been rewritten pretty much from
  ...
  * The overloading of :js:class:`~zgui.web.ListView.Groups` and
    :js:class:`~zgui.web.ListView.List` for editability has been
    drastically simplified, and most of the behavior has been moved to
    the list view itself. Only
    :js:func:`~zgui.web.ListView.List.row_clicked` is still
    overridden.
...
* :js:func:`~zgui.web.ListView.do_button_action`'s core behavior
  has been split away to
  :js:func:`~zgui.web.ListView.handle_button`. This allows bypassing
  overrides of :js:func:`~zgui.web.ListView.do_button_action` in a
  parent class.

  Ideally, :js:func:`~zgui.web.ListView.handle_button` should not be
  overridden.
