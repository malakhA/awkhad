...
from awkhad.addons.test_mass_mailing.tests.common import MassMailingCase
from awkhad.addons.base.models.ir_config_parameter import IrConfigParameter
from awkhad.tests.common import TransactionCase, users
