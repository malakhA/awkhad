awkhad.define('partner_autocomplete.tests', function (require) {
    "use strict";
    ...
    QUnit.module('partner_autocomplete', {
        before: function () {
            var suggestions = [
                {name: "Awkhad", website: "awkhad.com", domain: "awkhad.com", logo: "awkhad.com/logo.png", vat: "BE0477472701"}
            ];
            ...
            testUtils.patch(AutocompleteCore, {
                ...
                _getAwkhadSuggestions(value, isVAT) {
                ...
                _getClearbitSuggestions(value) {
                    return this._getAwkhadSuggestions(value);
                },
            });
    ...
    QUnit.test("Partner autocomplete : Company type = Individual", function (assert) {
        ...
        createView({
            ...
            $input.val("awkhad").trigger("input");
        ...
        createView({
            ...
            mockRPC: function (route, args) {
                ...
                if (route === "/web/static/src/img/placeholder.png"
                    || route === "awkhad.com/logo.png"
                    || route === "data:image/png;base64,awkhadbase64") { // land here as it is not valid base64 content
                    return $.when();
                }
            ...
            assert.strictEqual($input.val(), "Awkhad", "Input value should have been updated to \"Awkhad\"");
            assert.strictEqual(form.$("input.o_field_widget").val(), "awkhad.com", "website value should have been updated to \"awkhad.com\"");
            ...
            $input.val("awkhad").trigger("input");
            $dropdown = form.$(".o_field_partner_autocomplete .dropdown-menu:visible");
            assert.strictEqual($dropdown.length, 1, "there should be an opened dropdown when typing awkhad letters again");
