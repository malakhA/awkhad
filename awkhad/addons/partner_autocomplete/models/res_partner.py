...
import logging
import json
from awkhad import api, fields, models, exceptions, _
from awkhad.addons.iap import jsonrpc
from requests.exceptions import ConnectionError, HTTPError
from awkhad.addons.iap.models.iap import InsufficientCreditError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://partner-autocomplete.awkhad.com'
