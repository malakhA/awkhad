...
from awkhad.tools import consteq, float_round, image_resize_images, image_resize_image, ustr
from awkhad.addons.base.models import ir_module
from awkhad.exceptions import ValidationError
from awkhad import api, SUPERUSER_ID
from awkhad.tools.misc import DEFAULT_SERVER_DATETIME_FORMAT
from awkhad.tools.misc import formatLang
...
class PaymentAcquirer(models.Model):
    ...
    ZgUI and the acquirer. It generally consists in return urls given to the
    ...
    capture_manually = fields.Boolean(string="Capture Amount Manually",
        help="Capture the amount from Awkhad, when the delivery is completed.")
