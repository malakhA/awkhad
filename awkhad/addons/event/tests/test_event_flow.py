...
from awkhad.addons.event.tests.common import TestEventCommon
from awkhad.exceptions import ValidationError, UserError, AccessError
from awkhad.tools import mute_logger
from awkhad.fields import Datetime
try:
...
class TestEventFlow(TestEventCommon):
    ...
    def test_event_date_range(self):
        self.patcher = patch('awkhad.addons.event.models.event.fields.Datetime', wraps=Datetime)
