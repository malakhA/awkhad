awkhad.define('mail_bot.systray.MessagingMenuTests', function (require) {
"use strict";
...
QUnit.test('messaging menu widget: rendering with AwkhadBot has a request', function (assert) {
    assert.expect(5);
    ...
    assert.strictEqual(messagingMenu.$('.o_preview_name').text().trim(),
        'AwkhadBot has a request',
        "preview should display that AwkhadBot has a request");
...
QUnit.test('messaging menu widget: rendering without AwkhadBot has a request (denied)', function (assert) {
    assert.expect(3);
...
QUnit.test('messaging menu widget: rendering without AwkhadBot has a request (accepted)', function (assert) {
    assert.expect(3);
