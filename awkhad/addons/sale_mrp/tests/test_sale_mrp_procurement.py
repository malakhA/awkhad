...
from awkhad.tests.common import TransactionCase, Form
...
class TestSaleMrpProcurement(TransactionCase):
    ...
    def test_sale_mrp(self):
        ...
        # In order to test the sale_mrp module in ZgUI, I start by creating a new product 'Slider Mobile'
        # I define product category Mobile Products Sellable.

        with mute_logger('awkhad.tests.common.onchange'):
