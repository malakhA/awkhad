function initialize_map() {
    ...
    var map = new google.maps.Map(document.getElementById('awkhad-google-map'), {
        zoom: 1,
    ...
    if (awkhad_partner_data){ /* awkhad_partner_data special variable should have been defined in google_map.xml */
        for (var i = 0; i < awkhad_partner_data.counter; i++) {
            set_marker(awkhad_partner_data.partners[i]);
        }
