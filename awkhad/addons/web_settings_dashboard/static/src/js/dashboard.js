awkhad.define('web_settings_dashboard', function (require) {
"use strict";
...
var DashboardApps = Widget.extend({
    ...
    start: function() {
        ...
        if (awkhad.db_info && _.last(awkhad.db_info.server_version_info) !== 'e') {
    ...
    confirm_upgrade: function() {
        framework.redirect("https://www.awkhad.com/awkhad-enterprise/upgrade?num_users=" + (this.data.enterprise_users || 1));
    },
});
...
var DashboardShare = Widget.extend({
    ...
    init: function (parent, data) {
        this.data = data;
        this.parent = parent;
        this.share_url = 'https://www.awkhad.com';
        this.share_text = encodeURIComponent("I am using #Awkhad - Awesome open source business apps.");
        return this._super.apply(this, arguments);
    },
    ...
    share_linkedin: function (ev) {
        ev.preventDefault();
        var popup_url = _.str.sprintf('http://www.linkedin.com/shareArticle?mini=true&url=%s&title=I am using awkhad&summary=%s&source=www.awkhad.com', encodeURIComponent(this.share_url), this.share_text);
        this.sharer(popup_url);
    },
