...
class TestWebsiteSaleComparison(awkhad.tests.TransactionCase):
...
class TestUi(awkhad.tests.HttpCase):
    ...
    def test_01_admin_tour_product_comparison(self):
        self.phantom_js("/", "awkhad.__DEBUG__.services['web_tour.tour'].run('product_comparison')", "awkhad.__DEBUG__.services['web_tour.tour'].tours.product_comparison.ready", login='admin')
