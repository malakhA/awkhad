awkhad.define('pos_mercury.pos_mercury', function (require) {
"use strict";
...
PaymentScreenWidget.include({
    // How long we wait for the awkhad server to deliver the response of
        ...
        rpc.query({
            ...
            .then(function (data) {
                ...
                if (data === "internal error") {
                    def.resolve({
                        message: _t("Awkhad error while processing transaction.")
                    });
                    return;
                }
