...
from awkhad import models, api, service
from awkhad.tools.translate import _
from awkhad.exceptions import UserError
from awkhad.tools import DEFAULT_SERVER_DATETIME_FORMAT, misc
...
class MercuryTransaction(models.Model):
    ...
    def _setup_request(self, data):
        ...
        data['memo'] = "Awkhad " + service.common.exp_version()['server_version']
