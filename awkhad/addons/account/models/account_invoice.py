...
from awkhad.tools import email_re, email_split, email_escape_char, float_is_zero, float_compare, \
    pycompat, date_utils
from awkhad.tools.misc import formatLang

from awkhad.exceptions import AccessError, UserError, RedirectWarning, ValidationError, Warning
...
class AccountInvoice(models.Model):
    ...
    def message_new(self, msg_dict, custom_values=None):
        ...
        # 2) otherwise, if the email sender is from awkhad internal users then it is likely that the vendor sent the bill
