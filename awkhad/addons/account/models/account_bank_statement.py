...
from awkhad.tools import float_is_zero, pycompat
from awkhad.tools import float_compare, float_round, float_repr
from awkhad.tools.misc import formatLang, format_date
...
class AccountBankStatementLine(models.Model):
    ...
    def _check_amount(self):
        ...
        # so that user can enter/import the exact bank statement they have received from their bank in Awkhad
