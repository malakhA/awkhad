...
from awkhad.exceptions import RedirectWarning, UserError, ValidationError
from awkhad.tools.misc import formatLang, format_date
from awkhad.tools import float_is_zero, float_compare
...
class AccountMoveLine(models.Model):
    ...
    def _apply_taxes(self, vals, amount):
        tax_lines_vals = []
        # Get ids from triplets : https://www.awkhad.com/documentation/10.0/reference/orm.html#awkhad.models.Model.write
