...
import io
import os
from awkhad.tools import misc
import urllib3
from pathlib import Path

from uuid import getnode as get_mac
from awkhad.addons.hw_proxy.controllers import main as hw_proxy
from awkhad.addons.web.controllers import main as web
from awkhad.modules.module import get_resource_path
from awkhad.addons.hw_drivers.controllers.driver import iot_devices, get_ip, get_awkhad_server_url
...
if hasattr(sys, 'frozen'):
    ...
    loader = jinja2.PackageLoader('awkhad.addons.hw_posbox_homepage', "views")
...
class IoTboxHomepage(web.Home):
    ...
    def get_hw_screen_message(self):
        ...
        <p>
            ...
            You can find the latest images on the <a href="http://nightly.awkhad.com/master/posbox/">Awkhad Nightly builds</a> website.
            Make sure to download at least the version 16.<br/>
            Awkhad version 11, or above, is required to use the customer display feature.
        </p>
        """
    ...
    def get_homepage_data(self):
        ...
        return {
            ...
            'server_status': get_awkhad_server_url() or 'Not Configured',
    ...
    def index(self):
        ...
        remote_server = Path.home() / 'awkhad-remote-server.conf'
    ...
    def list_drivers(self):
        ...
        return driver_list_template.render({
            'title': "Awkhad's IoT Box - Drivers list",
    ...
    def load_drivers(self):
        ...
        subprocess.check_call("sudo service awkhad restart", shell=True)
    ...
    def connect_to_wifi(self, essid, password, persistent=False):
        ...
        if server:
            res_payload['server'] = {
                'url': server,
                'message': 'Redirect to Awkhad Server'
            }
    ...
    def server(self):
        return server_config_template.render({
            'title': 'IoT -> Awkhad server configuration',
            'breadcrumb': 'Configure Awkhad Server',
            'hostname': subprocess.check_output('hostname').decode('utf-8').strip('\n'),
            'server_status': get_awkhad_server_url() or 'Not configured yet',
