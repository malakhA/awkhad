...
from awkhad.tools import DEFAULT_SERVER_DATE_FORMAT, DEFAULT_SERVER_DATETIME_FORMAT, pycompat
...
class Meeting(models.Model):
        ...
        for meeting in self:
            ...
            if meeting.alarm_ids:
                for alarm in meeting.alarm_ids:
                    ...
                    trigger.value = delta
                    valarm.add('DESCRIPTION').value = alarm.name or u'Awkhad'
    ...
    def _rrule_parse(self, rule_str, data, date_start):
        ...
        #repeat yearly but for awkhad it's monthly, take same information as monthly but interval is 12 times
        if rule._bymonth:
