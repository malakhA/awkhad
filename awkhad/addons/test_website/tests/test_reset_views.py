...
class TestWebsiteResetViews(awkhad.tests.HttpCase):
    def do_test(self, name):
        self.browser_js(
            "/",
            "awkhad.__DEBUG__.services['web_tour.tour'].run('%s')" % name,
            "awkhad.__DEBUG__.services['web_tour.tour'].tours.%s.ready" % name,
            login="admin"
        )
    ...
    @mute_logger('awkhad.addons.website.models.ir_http')
    ...
    # @mute_logger('awkhad.addons.website.models.ir_http', 'awkhad.addons.website.models.ir_ui_view')
