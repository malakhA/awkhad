...
from awkhad import _, api, fields, models, modules, SUPERUSER_ID, tools
from awkhad.exceptions import UserError, AccessError
from awkhad.osv import expression
from awkhad.tools import groupby, formataddr
...
class Message(models.Model):
    ...
    def _notify_compute_recipients(self, record, msg_vals):
        ...
        for pid, cid, active, pshare, ctype, notif, groups in res:
            ...
            if pid:
                if active is False:
                    # avoid to notify inactive partner by email (awkhadbot)
                    continue
