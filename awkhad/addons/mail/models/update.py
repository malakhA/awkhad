...
from awkhad import api, release, SUPERUSER_ID
from awkhad.exceptions import UserError
from awkhad.models import AbstractModel
from awkhad.tools.translate import _
from awkhad.tools import config, misc, ustr
...
class PublisherWarrantyContract(AbstractModel):
    ...
    def update_notification(self, cron_mode=True):
        """
        Send a message to Awkhad's publisher warranty server to check the
