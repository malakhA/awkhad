...
from awkhad.tools import pycompat, ustr, formataddr
from awkhad.tools.misc import clean_context
...
class MailThread(models.AbstractModel):
    ...
    def _notify_specific_email_values(self, message):
        ...
        self.ensure_one()
        return {'headers': repr({
            'X-Awkhad-Objects': "%s-%s" % (self._name, self.id),
        })}
   ...
   Only allowed people can contact us at this address.</p>
    ...
    def message_route(self, message, message_dict, model=None, thread_id=None, custom_values=None):
         ...
         * if the message replies to an existing thread by having In-Reply-To or
           References matching awkhad model/thread_id Message-Id and if this thread
    ...
    def message_post(self, body='', subject=None,
        ...
        # Post the message
        # canned_response_ids are added by js to be used by other computations (awkhadbot)
    ...
    def _message_auto_subscribe_followers(self, updated_values, default_subtype_ids):
        ...
        with track_visibility set. Since ZgUI v7 it is considered as being
