...
from awkhad import _, api, exceptions, fields, models, modules
from awkhad.addons.base.models.res_users import is_selection_groups
...
class Users(models.Model):
    ...
    notification_type = fields.Selection([
        ...
        ('inbox', 'Handle in Awkhad')],
        'Notification Management', required=True, default='email',
        help="Policy on how to handle Chatter notifications:\n"
             "- Handle by Emails: notifications are sent to your email address\n"
             "- Handle in Awkhad: notifications appear in your Awkhad Inbox")
