awkhad.define('mail.model.Message', function (require) {
"use strict";
...
var Message =  AbstractMessage.extend(Mixins.EventDispatcherMixin, ServicesMixin, {
    ...
    getAvatarSource: function () {
        if (this._isAwkhadbotAuthor()) {
            return '/mail/static/src/img/awkhadbot.png';
     ...
     *
     * Do not redirect on author clicked of self-posted or Awkhadbot messages
     * (note: Awkhadbot is the default author of transient messages)
     *
     * @override
     * @return {boolean}
     */
    shouldRedirectToAuthor: function () {
        return this._super.apply(this, arguments) && !this._isAwkhadbotAuthor();
    },
    /**
    ...
    /**
     * Get the name of the author of this message.
     * If Awkhadbot is the author (default author for transient messages),
     * returns 'Awkhadbot'.
     *
     * @override
     * @private
    ...
    /**
     * State if the author of this message is AwkhadBot
     * This is the default author for transient messages.
     *
     * @private
     * @return {boolean}
     */
    _isAwkhadbotAuthor: function () {
        return this._serverAuthorID === this.call('mail_service', 'getAwkhadbotID');
    },
    /**
