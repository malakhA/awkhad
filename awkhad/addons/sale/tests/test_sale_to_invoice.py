...
from awkhad.tools import pycompat, float_is_zero
...
class TestSaleToInvoice(TestCommonSaleNoChart):
    ...
    def test_invoice_refund(self):
        ...
        credit_note_wizard = self.env['account.invoice.refund'].with_context({'active_ids': [invoice.id], 'active_id': invoice.id}).create({
            'filter_refund': 'modify',  # this is the only mode for which the SO line is linked to the refund (https://github.com/awkhad/awkhad/commit/e680f29560ac20133c7af0c6364c6ef494662eac)
