awkhad.define('im_support.systray.MessagingMenu', function (require) {
"use strict";
...
MessagingMenu.include({
    ...
    init: function () {
        ...
        this.supportChannel = {
            ...
            name: _t("Awkhad Live Support"),
            title: _t("Awkhad Live Support"),
            imageSRC: '/mail/static/src/img/awkhad_o.png',
        };
    },
    /**
