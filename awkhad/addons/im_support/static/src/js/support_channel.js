awkhad.define('im_support.SupportChannel', function (require) {
"use strict";
...
var SupportChannel = SearchableThread.extend({
    ...
    _addSupportNotAvailableMessage: function () {
        var msg = {
            author_id: this.call('mail_service', 'getAwkhadbotID'),
            body: _t("None of our operators are available. <a href='https://www.awkhad.com/help' " +
    ...
    _fetchMessages: function (pDomain, loadMore) {
        ...
        return supportSession.rpc('/awkhad_im_support/fetch_messages', {
                domain: domain,
    ...
    _postMessage: function (data) {
        ...
        return supportSession.rpc('/awkhad_im_support/chat_post', {
