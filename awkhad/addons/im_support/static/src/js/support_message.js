awkhad.define('im_support.SupportMessage', function (require) {
"use strict";
...
var SupportMessage = Message.extend({
    ...
    init: function () {
        ...
        if (this._serverAuthorID !== this.call('mail_service', 'getAwkhadbotID')) {
    ...
    getAvatarSource: function () {
        return '/mail/static/src/img/awkhad_o.png';
    },
    /**
