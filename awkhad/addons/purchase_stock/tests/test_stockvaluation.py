...
from awkhad.tests import Form
from awkhad.tests.common import TransactionCase, tagged
from awkhad.addons.account.tests.account_test_classes import AccountingTestCase
...
class TestStockValuationWithCOA(AccountingTestCase):
    ...
    def test_realtime_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        def _today(*args, **kwargs):
            return date_po
        patchers = [
            patch('awkhad.fields.Date.context_today', _today),
        ]
    ...
    def test_average_realtime_with_delivery_anglo_saxon_valuation_multicurrency_different_dates(self):
        ...
        patchers = [
            patch('awkhad.fields.Date.context_today', _today),
            patch('awkhad.fields.Datetime.now', _now),
        ]
