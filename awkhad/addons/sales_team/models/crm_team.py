...
from awkhad.release import version
from awkhad.tools import DEFAULT_SERVER_DATE_FORMAT as DF
...
class CrmTeam(models.Model):
    ...
    reply_to = fields.Char(string='Reply-To',
                           help="The email address put in the 'Reply-To' of all emails sent by Awkhad about cases in this Sales Team")
