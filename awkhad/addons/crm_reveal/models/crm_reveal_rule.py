...
from awkhad.addons.iap import jsonrpc
from awkhad.addons.crm.models import crm_stage
from awkhad.exceptions import ValidationError

_logger = logging.getLogger(__name__)

DEFAULT_ENDPOINT = 'https://iap-services.awkhad.com'
...
class CRMRevealRule(models.Model):
    ...
    industry_tag_ids = fields.Many2many('crm.reveal.industry', string='Industry Tags', help='Leave empty to always match. Awkhad will not create lead if no match')
    ...
    # Methods responsible for format response data in to valid awkhad lead data
