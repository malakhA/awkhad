awkhad.define('iap.CrashManager', function (require) {
"use strict";
...
CrashManager.include({
    ...
    _getButtonMessage: function (isTrial){
        var isEnterprise = _.last(awkhad.session_info.server_version_info) === 'e';
        return isTrial && isEnterprise ? _t('Start a Trial at Awkhad') : _t('Buy credits at Awkhad');
    },
    /**
     * @override
     */
    rpc_error: function (error) {
        var self = this;
        if (error.data.name === "awkhad.addons.iap.models.iap.InsufficientCreditError") {
            ...
            ajax.jsonRpc('/web/dataset/call_kw', 'call', {
                ...
                var content = $(QWeb.render('iap.redirect_to_awkhad_credit', {
                        data: error_data,
                    }));
                if (error_data.body) {
