...
from awkhad.tools import float_repr
from awkhad.exceptions import UserError, ValidationError
from awkhad.addons.base.models.ir_mail_server import MailDeliveryException
from awkhad.tests.common import Form
        ...
        for invoice in self:
            ...
            if len(invoice.commercial_partner_id.l10n_it_pa_index or '') == 6:
                invoice.message_post(
                    body=(_("Invoices for PA are not managed by Awkhad, you can download the document and send it on your own."))
                )
                invoice.l10n_it_send_state = "other"
                continue
