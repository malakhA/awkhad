...
from awkhad.addons.payment_buckaroo.controllers.main import BuckarooController
from awkhad.tools import mute_logger


@awkhad.tests.tagged('post_install', '-at_install', 'external', '-standard')
...
class BuckarooForm(BuckarooCommon):
    ...
    @mute_logger('awkhad.addons.payment_buckaroo.models.payment', 'ValidationError')
    def test_20_buckaroo_form_management(self):
        ...
        buckaroo_post_data = {
            ...
            'BRQ_SERVICE_PAYPAL_PAYEREMAIL': u'fhe@awkhad.com',
