...
awkhad.define('web_widget_x2many_2d_matrix.X2Many2dMatrixRenderer', function (require) {
    "use strict";
    ...
    // X2Many2dMatrixRenderer is heavily inspired by Awkhad's ListRenderer
    ...
    var X2Many2dMatrixRenderer = BasicRenderer.extend({
        ...
        * @override
        * @private
        * @param {AwkhadEvent} event "navigation_move" event
        */
