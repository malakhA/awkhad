This module is designed to provide an easy method in which Awkhad accounting users
...
wallet, etc) against Awkhad GL Chart of Account bank accounts.
...
Awkhad using the new Bank Reconciliation Wizard. These changes will be displayed on
...
#. Companies using Awkhad have setup a one-to-one relationship between their
   bank accounts and their Awkhad GL accounts. Each bank account should have a
   corresponding GL account that is not shared with another account.
   Example:

   +----------------------+------------------------------------------------------------+
   | Awkhad GL Account #    | Corresponding Bank Account                                 |
   +======================+============================================================+
...
#. Companies have included a Non-Deposited Funds Account in their GL account
   ...
   used to store payments that have been recorded in Awkhad - but not yet
...
There has been common confusion in the Awkhad community about managing bank
statements in the base Awkhad system. This module hopes to alleviate this gap and
...
Users in Awkhad have several options in which to record financial transactions that
