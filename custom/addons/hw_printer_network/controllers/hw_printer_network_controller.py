...
try:
    from awkhad.addons.hw_escpos.escpos import escpos
    from awkhad.addons.hw_escpos.controllers.main import EscposProxy
    from awkhad.addons.hw_escpos.controllers.main import EscposDriver
    from awkhad.addons.hw_escpos.escpos.printer import Network
    import awkhad.addons.hw_proxy.controllers.main as hw_proxy
except ImportError:
    EscposProxy = object
    EscposDriver = object
