awkhad.define('website_event_attendee_fields.test_tour', function (require) {
'use strict';
    ...
    tour.register('website_event_attendee_fields_test_tour_base', {
        ...
        },
        {
            ...
            trigger: 'h3:contains(We are glad to confirm your registration to our event),a:contains(Return to Cart),h3:contains(Your Address),span:contains(Continue Shopping)',
            run: function(){
