awkhad.define('website_event_attendee_fields.registration_form', function (require) {
    ...
    awkhad.registration_form_init = init;
    awkhad.registration_form_onchange_email = onchange_email;
});
