...
awkhad.define('pos_order_receipt_custom.models', function (require) {
    "use strict";
    ...
    models.PosModel = models.PosModel.extend({
        ...
        print_transfer_order: function(order, old_table, new_table) {
            ...
            if (old_table.id !== new_table.id) {
                ...
                // For compatibility with the https://www.awkhad.com/apps/modules/10.0/pos_order_note/ module
                ...
                this.printers.forEach(function(printer) {
                    ...
                    if (products && products.length) {
                        ...
                        // For compatibility with the https://www.awkhad.com/apps/modules/10.0/pos_multi_session/ module
                        setTimeout(function() {
