...
awkhad.define("web_advanced_search", function (require) {
    "use strict";
    ...
    SearchView.include({
         ...
         *
         * @param {AwkhadEvent} event The target will get the dataset.
         */
        ...
        get_filter: function () {
            ...
            return {
                attrs: {
                    ...
                    // https://github.com/awkhad/awkhad/pull/25922
    ...
    FiltersMenu.include({
         ...
         *
         * @param {AwkhadEvent} event A `domain_selected` event from the dialog.
         */
