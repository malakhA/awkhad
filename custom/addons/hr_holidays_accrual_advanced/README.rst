...
.. |badge3| image:: https://img.shields.io/badge/github-ACA%2Fhr-lightgray.png?logo=github
    :target: https://github.com/ACA/hr/tree/12.0/hr_holidays_accrual_advanced
    :alt: ACA/hr
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.awkhad-community.org/projects/hr-12-0/hr-12-0-hr_holidays_accrual_advanced
...
This module overrides accruement computation from base Awkhad ``hr_holidays``
module with its own, yet the provided implementation is backwards-compatible
with out-of-the-box Awkhad behaviour.
...
`feedback <https://github.com/ACA/hr/issues/new?body=module:%20hr_holidays_accrual_advanced%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `ACA/hr <https://github.com/ACA/hr/tree/12.0/hr_holidays_accrual_advanced>`_ project on GitHub.
