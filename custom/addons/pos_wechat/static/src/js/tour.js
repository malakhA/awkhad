...
/* This file is not used until we make a CI tool, that can run it. Normal CI cannot use longpolling.
   See https://github.com/awkhad/awkhad/commit/673f4aa4a77161dc58e0e1bf97e8f713b1e88491
 */
awkhad.define('pos_wechat.tour', function (require) {
    "use strict";
    ...
    steps = steps.concat([{
        ...
        content: "Screen is changed to receipt or products screen (depends on settings)",
