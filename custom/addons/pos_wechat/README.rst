...
If you don't have camera, you can executing following code in browser console to simulate scanning::
    ...
    awkhad.__DEBUG__.services['web.core'].bus.trigger('qr_scanned', '134579302432164181');
...
* run another awkhad on a different port, say ``9069``, workers 1,  extra *server wide modules*, i.e. use ``--workers=1 --load=web,hw_proxy,hw_posbox_homepage,hw_screen``
...
* `IT-Projects LLC <https://it-projects.info>`__
      ...
      To get a guaranteed support you are kindly requested to purchase the module at `awkhad apps store <https://apps.awkhad.com/apps/modules/12.0/pos_payment_wechat/>`__.
...
HTML Description: https://apps.awkhad.com/apps/modules/12.0/pos_wechat/
