...
.. |badge2| image:: https://img.shields.io/badge/github-ACA%2Fqueue-lightgray.png?logo=github
    :target: https://github.com/ACA/queue/tree/12.0/base_import_async
    :alt: ACA/queue
.. |badge3| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.awkhad-community.org/projects/queue-12-0/queue-12-0-base_import_async
...
`feedback <https://github.com/ACA/queue/issues/new?body=module:%20base_import_async%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `ACA/queue <https://github.com/ACA/queue/tree/12.0/base_import_async>`_ project on GitHub.
