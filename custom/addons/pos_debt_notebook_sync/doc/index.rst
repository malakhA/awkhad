...
* Check instruction for `POS longpolling <https://apps.awkhad.com/apps/modules/10.0/pos_longpolling/>`_ about activating longpolling
...
* on the first POS:
  ...
  * OR add usual products and register Debt payment. See `Debt notebook module <https://apps.awkhad.com/apps/modules/10.0/pos_debt_notebook/>`_ for more information.
  * click ``[Validate]``
