...
try:
    ...
    _logger.error('pos_multi_session_sync inconsisten with awkhad version')
    BusController = object


class Controller(BusController):

    @awkhad.http.route('/pos_multi_session_sync/update', type="json", auth="public")
    ...
    @awkhad.http.route('/pos_multi_session/test/gc', type="http", auth="user")
