...
The module is used for `Sync POS orders across multiple sessions <https://apps.awkhad.com/apps/modules/12.0/pos_multi_session>`__. It provides the synchronization for POS multi-session and allows to use a separate sync server for data storage and processing.
...
* `IT-Projects LLC <https://it-projects.info>`__
      ...
      at `awkhad apps store <https://apps.awkhad.com/apps/modules/12.0/pos_multi_session_sync/>`__.
...
HTML Description: https://apps.awkhad.com/apps/modules/12.0/pos_multi_session_sync/
