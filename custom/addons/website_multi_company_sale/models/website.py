...
from awkhad import models, api, tools, fields
from awkhad.addons.website_sale.models.website import Website as WebsiteOriginal
...
class Website(models.Model):
    ...
    def _get_pl_partner_order(self, country_code, show_visible, website_pl, current_pl, all_pl, partner_pl=False, order_pl=False):
        """The extension can be removed once a branch has following update: https://github.com/awkhad/awkhad/pull/26414"""
