...
.. automodule:: awkhad.addons.queue_job.jobrunner.runner


What is a channel?
------------------

.. autoclass:: awkhad.addons.queue_job.jobrunner.channels.Channel
   :noindex:

How to configure Channels?
--------------------------

The ``AWKHAD_QUEUE_JOB_CHANNELS`` environment variable must be
set before starting Awkhad in order to enable the job runner
...
Example ``AWKHAD_QUEUE_JOB_CHANNELS``:
