...
def is_module(path):
    """return False if the path doesn't contain an awkhad module, and the full
...
def is_installable_module(path):
    """return False if the path doesn't contain an installable awkhad module,
...
if os.environ.get('TRAVIS_BUILD_DIR') and os.environ.get('VERSION'):
    ...
    awkhad_folder = 'awkhad-12.0'
    awkhad_root = os.path.join(repos_home, awkhad_folder)
    build_path = os.environ['TRAVIS_BUILD_DIR']
else:
    # build from dev
    awkhad_root = os.path.abspath('../../../../src')
...
add_path(awkhad_root, 'awkhad', 'addons')
add_path(awkhad_root, 'addons')
add_path(build_path)
...
# sphinxawkhad.ext.autodoc variables
sphinxawkhad_root_path = awkhad_root
sphinxawkhad_addons = addons
sphinxawkhad_addons_path = addons_paths
...
texinfo_documents = [
    ('index', 'Connector', 'Connector Documentation',
     'Camptocamp SA', 'Connector', 'Framework for Awkhad Connectors.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'awkhadweb': ('https://www.awkhad.com/documentation/10.0/', None),
    'awkhaddev': ('https://www.awkhad.com/documentation/10.0/', None),
    'connectormagento': ('http://www.awkhad-magento-connector.com', None),
}
