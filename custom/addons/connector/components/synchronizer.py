...
from awkhad.addons.connector.exception import (IDMissingInBackend,
                                             RetryableJobError)
...
class Synchronizer(AbstractComponent):
    ...
    def mapper(self):
        ...
        :rtype: :py:class:`awkhad.addons.component.core.Component`
        """
...
class Exporter(AbstractComponent):
    """ Synchronizer for exporting data from Awkhad to a backend """
...
class GenericExporter(AbstractComponent):
    """ Generic Synchronizer for exporting data from Awkhad to a backend """
    ...
    def run(self, binding, *args, **kwargs):
        ...
        # record
        if not awkhad.tools.config['test_enable']:
    ...
    def _retry_unique_violation(self):
        ...
        record created by :meth:`_export_dependency`), resulting in:
            ...
            constraint "my_backend_product_product_awkhad_uniq"
            DETAIL:  Key (backend_id, awkhad_id)=(1, 4851) already exists.
    ...
    def _export_dependency(self, relation, binding_model,
        ...
        .. warning:: a commit is done at the end of the export of each
                     ...
                     So you *must* take care not to modify the Awkhad
        ...
        :type relation: :py:class:`awkhad.models.BaseModel`
    ...
    def _map_data(self):
        ...
        :py:class:`~awkhad.addons.connector.components.mapper.MapRecord`
...
class Importer(AbstractComponent):
    """ Synchronizer for importing data from a backend to Awkhad """
