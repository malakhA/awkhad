...
from awkhad.addons.connector.exception import RetryableJobError
...
class RecordLocker(Component):
    ...
    def lock(self, records, seconds=None, ignore_retry=True):
        ...
        retried later
        (:exc:`~awkhad.addons.queue_job.exception.RetryableJobError` is raised).
        ...
        :exc:`~awkhad.addons.queue_job.exception.RetryableJobError`
