...
class ConnectorListener(AbstractComponent):
    ...
    def no_connector_export(self, record):
        ...
        To be used with :func:`awkhad.addons.component_event.skip_if`
        on Events::
