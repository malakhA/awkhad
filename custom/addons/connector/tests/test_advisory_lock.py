...
from awkhad.addons.connector.database import pg_try_advisory_lock
from awkhad.addons.component.core import WorkContext
from awkhad.addons.component.tests.common import TransactionComponentCase
...
class TestAdvisoryLock(TransactionComponentCase):
    ...
    def test_concurrent_import_lock(self):
        ...
        # instanciate another component using a different awkhad env
