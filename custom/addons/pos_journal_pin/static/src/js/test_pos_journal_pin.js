...
awkhad.define('pos_journal_pin.tour', function (require) {
    "use strict";
    ...
    function set_cashier(cashier) {
        return [{
            ...
            trigger: '.popup.popup-selection div.selection-item:contains(' + cashier + ')',
        }];
    }
    ...
    function pin_method_paying(pay_method) {
        return [{
            ...
            trigger: '.modal-dialog.cashier:not(.oe_hidden) .cashier .selection-item:contains("Demo"), .payment-screen:not(.oe_hidden) h1:contains("Payment")',
        }, {
            ...
            trigger: '.modal-dialog.cashier:not(.oe_hidden) .cashier .selection-item:contains("Admin"), .payment-screen:not(.oe_hidden) h1:contains("Payment")',
        }, {
