awkhad.define('media_form_widget', function(require) {
    ...
    KanbanRecord.include({
        _getImageURL: function (model, field, id, cache, options) {
            ...
            } else if(this.recordData.media_type === 'application/vnd.openxmlformats-officedocument.wordprocessingml.document') {
            ...
            } else if(this.recordData.media_type === 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet') {
