...
from awkhad.http import request, STATIC_CACHE
...
class IrHttp(models.AbstractModel):
    ...
    def find_field_attachment(cls, env, model, field, obj):
        ...
        if not att and model == 'product.product':
            ...
            # this computation awkhad pass binary data (by downloading it
    ...
    def binary_content(cls, xmlid=None, model='ir.attachment', id=None, field='datas',  # pylint: disable=redefined-builtin
        ...
        if model == 'ir.attachment' and obj.type == 'url' and obj.url:
            ...
            # begin redefined part of original binary_content of awkhad/base/addons/ir/ir_http
            ...
            if att:
                ...
                # https://github.com/awkhad/awkhad/blob/98a137e4b1f631a10d46b5e0cb21bb83ed7e861f/awkhad/addons/base/ir/ir_http.py#L312
