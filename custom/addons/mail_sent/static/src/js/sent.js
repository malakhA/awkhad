...
awkhad.define('mail_sent.sent', function (require) {
"use strict";
...
Manager.include({
    ...
    addMessage: function (data, options) {
        ...
        } else if (data.author_id && data.author_id[0] && awkhad.session_info.partner_id &&
                   data.author_id[0] === awkhad.session_info.partner_id) {
