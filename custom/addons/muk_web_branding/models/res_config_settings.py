...
class ResConfigSettings(models.TransientModel):
    ...
    def _get_branding_primary_colors(self):
        ...
        if colors['o-brand-awkhad'] == '$o-community-color':
            colors['o-brand-awkhad'] = colors['o-community-color']
        if colors['o-brand-awkhad'] == '$o-enterprise-color':
            colors['o-brand-awkhad'] = colors['o-enterprise-color']
        ...
        if colors['o-brand-lightsecondary'] == '$o-gray-100':
            colors['o-brand-lightsecondary'] = colors['o-gray-100']
        return {
            'branding_color_brand': colors['o-brand-awkhad'],
