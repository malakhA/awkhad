...
class TestAccountPaymentResidualAmount(TransactionCase):
    """
        Tests for Account Payment Residual Amount.
    """
    def setUp(self):
        super(TestAccountPaymentResidualAmount, self).setUp()
        # Models
    ...
    def test_01(self):
        """ Tests that I can create a payment, and partially reconcile it
        with an invoice.
        I expect:
        ...
        invoice.assign_outstanding_credit(payment_ml.id)
        self.assertEquals(payment.amount_residual, 800)
        self.assertEqual(payment_ml.amount_residual, -800.0)
    ...
    def test_02(self):
        ...
        payment_ml = payment.move_line_ids.filtered(
            lambda l: l.account_id == self.account_receivable)
        invoice.assign_outstanding_credit(payment_ml.id)
        self.assertEquals(payment.amount_residual, 900)
    ...
    def test_04(self):
        ...
        self.assertEquals(payment.amount_residual, 600)
