...
class Base(models.AbstractModel):
    ...
    A new :meth:`~with_delay` method is added on all Awkhad Models, allowing to
    ...
    def with_delay(self, priority=None, eta=None,
        ...
        Model which is decorated by :func:`~awkhad.addons.queue_job.job.job`.
        ...
        :rtype: :class:`awkhad.addons.queue_job.job.DelayableRecordset`
        ...
        In tests you'll have to mute the logger like:
            ...
            @mute_logger('awkhad.addons.queue_job.models.base')
        """
