...
class Channel(object):
    ...
    are actually sent to Awkhad for execution.
    ...
    def get_jobs_to_run(self, now):
        ...
        :return: iterator of
                 :class:`awkhad.addons.queue_job.jobrunner.ChannelJob`
        """
...
class ChannelManager(object):
    ...
    * get jobs to run
    ...
    def parse_simple_config(cls, config_string):
        ...
        would be generated by trailing commas, or commented lines on the Awkhad
        config file.
        ...
        readable if the channel configuration comes from the awkhad config file.
