...
class TestUi(awkhad.tests.HttpCase):
    ...
    def test_01_partner_deselection(self):
        ...
        self.phantom_js(
            '/web',
            "awkhad.__DEBUG__.services['web_tour.tour'].run('pos_partner_deselection_tour'), 500",
            "awkhad.__DEBUG__.services['web_tour.tour'].tours.pos_partner_deselection_tour.ready",
            login="admin",
            timeout=100,
        )
