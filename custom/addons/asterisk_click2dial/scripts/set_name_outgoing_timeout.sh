...
timeout 2s set_name_agi.py --jsonrpc --ssl --server awkhad.mycompany.com --database erp_prod --username "asterisk" --password "thepasswd" --outgoing --outgoing-agi-variable extension
