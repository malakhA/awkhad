...
# echo "agi_callerid:0141401242"|awkhad_popup_timeout.sh
...
timeout 2s set_name_agi.py --server awkhad.mycompany.com --database erp_prod --user-id 12 --password "thepasswd" --notify admin demo
