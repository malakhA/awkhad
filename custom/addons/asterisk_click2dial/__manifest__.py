...

{
    ...
    'category': 'Phone',
    'license': 'AGPL-3',
    'summary': 'Asterisk-Awkhad connector',
    'description': """
Asterisk-Awkhad connector
==========================
...
1) It adds a *Dial* button in the partner form view so that users can directly
   ...
   *click2dial*. Here is how it works :
    ...
    * In Awkhad, the user clicks on the *Dial* button next to a phone number
      field in the partner view.

    * Awkhad connects to the Asterisk Manager Interface and Asterisk makes the
      user's phone ring.

    * The user answers his own phone (if he doesn't, the process stops here).

    * Asterisk dials the phone number found in Awkhad in place of the user.
...
2) It adds the ability to show the name of the calling party on the screen of
   ...
   present in the partner/leads/employees/... of Awkhad. Here is how it works:
    ...
    * The "set_name_agi.py" script will make an XML-RPC request on the Awkhad
...
3) It adds a phone icon (*Open Caller*) in the top menu bar
    ...
    * When the user clicks on the phone icon, Awkhad sends a query to the
    ...
    * It searches the phone number of the calling party in the
      Partners/Leads/Candidates/Registrations of Awkhad. If a record matches,
...
http://www.akretion.com/products-and-services/zgui-asterisk-voip-connector
""",
