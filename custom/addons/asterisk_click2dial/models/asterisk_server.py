...
class AsteriskServer(models.Model):
    ...
    login = fields.Char(
        ...
        help="Login that Awkhad will use to communicate with the "
    ...
    password = fields.Char(
        ...
        help="Password that Awkhad will use to communicate with the "
        "Asterisk Manager Interface. Refer to /etc/asterisk/manager.conf "
        "on your Asterisk server.")
    context = fields.Char(
    ...
    def _connect_to_asterisk(self):
        ...
        try:
            ...
            raise UserError(_(
                "Problem in the request from Awkhad to Asterisk. "
    ...
    def test_ami_connection(self):
        ...
        try:
            ...
            if ast_manager:
                ast_manager.Logoff()
        raise UserError(_(
            "Connection Test Successfull! Awkhad can successfully login to "
