...
Awkhad is designed to switch website by host name, but this feature is not completed and not supported. This module fills the gap.
...
HTML Description: https://apps.awkhad.com/apps/modules/12.0/website_multi_company/
