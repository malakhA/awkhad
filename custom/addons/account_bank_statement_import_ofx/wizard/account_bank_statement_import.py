...
from awkhad.addons.base_iban.models.res_partner_bank import _map_iban_template
from awkhad.addons.base_iban.models.res_partner_bank import validate_iban
...
class AccountBankStatementImport(models.TransientModel):
    ...
    def _prepare_ofx_transaction_line(self, transaction):
        ...
        # If you read awkhad10/addons/account_bank_statement_import/
