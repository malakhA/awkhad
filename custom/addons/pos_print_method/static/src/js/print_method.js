awkhad.define('pos_restaurant.print_method', function (require) {
    "use strict";
    ...
    models.Order = models.Order.extend({
        print_order_receipt: function(printer, changes) {
            ...
            // This check is required for compatibility with the module https://www.awkhad.com/apps/modules/10.0/pos_order_receipt_custom/
