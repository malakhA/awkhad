...
Activates the accounting dashboard and its features in Awkhad. After installing the
module, users can obtain the "Advisor" right for the "Accounting & Finance"
application. This feature was included in Awkhad version 9 and was removed from the
...
* `Awkhad <https://github.com/awkhad/awkhad>`_
