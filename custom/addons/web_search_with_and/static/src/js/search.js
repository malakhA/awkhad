awkhad.define('web_search_with_and', function (require) {
    "use strict";
    ...
    SearchView.SearchQuery.prototype = SearchView.SearchQuery.extend({
        // Override the awkhad method to (conditionally) add a search facet even if a existing
        ...
        // following code before the Awkhad native override (trick)
