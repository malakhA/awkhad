...
from awkhad import http, tools, service
from awkhad.http import request, db_monodb, db_list

from awkhad.addons.web.controllers.main import DBNAME_PATTERN
from awkhad.addons.web.controllers.main import jinja2, Database
...
if hasattr(sys, 'frozen'):
    ...
    loader = jinja2.PackageLoader('awkhad.addons.muk_saas_branding', 'templates')
...
class Database(Database):
    ...
    def _render_template(self, **d):
        ...
        d['system_name'] = tools.config.get(
            "database_manager_system_name", "Awkhad"
        )
