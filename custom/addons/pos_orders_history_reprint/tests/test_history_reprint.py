...
class TestUi(awkhad.tests.HttpCase):
    ...
    def test_01_pos_is_loaded(self):
        ...
        self.phantom_js(
            '/web',
            "awkhad.__DEBUG__.services['web_tour.tour'].run('pos_orders_history_reprint_tour', 500)",
            "awkhad.__DEBUG__.services['web_tour.tour'].tours.pos_orders_history_reprint_tour.ready",
            login="admin",
            timeout=240,
        )
