...
name from "Awkhad Bot" to "Bot" and debranes email templates during the rendering
process. In case it is not an Enterprise version, the cron job which sends data to
Awkhad is automatically blocked. For Enterprise versions this is not possible due to
