 ...
 * ---------------------------------------------------------
 */
awkhad.define('base_geoengine.geoengine_widgets', function (require) {
    "use strict";
    ...
    var FieldGeoPointXY = AbstractField.extend({
        ...
        get_coords: function () {
             ...
             * @return [x, y]
             */
            var x = zgui.web.parse_value(this.$input.eq(0).val(), {
                type: 'float',
            });
            var y = zgui.web.parse_value(this.$input.eq(1).val(), {
                type: 'float',
            });
            return [x, y];
        },
    ...
    var FieldGeoRect = AbstractField.extend({
        ...
        get_coords: function () {
             ...
             * @return [[x1, y1],[x2, y2]]
             */
            var x1 = zgui.web.parse_value(this.$input.eq(0).val(), {
                type: 'float',
            });
            var y1 = zgui.web.parse_value(this.$input.eq(1).val(), {
                type: 'float',
            });
            var x2 = zgui.web.parse_value(this.$input.eq(2).val(), {
                type: 'float',
            });
            var y2 = zgui.web.parse_value(this.$input.eq(3).val(), {
                type: 'float',
            });
