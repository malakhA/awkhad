...
from awkhad.exceptions import MissingError
from awkhad.tools import sql

logger = logging.getLogger('geoengine.sql')
_schema = logging.getLogger('awkhad.schema')
    ...
    """)
        ...
        raise MissingError(
            _(
                ...
                " to be installed. If you do not want Awkhad to connect with a"
