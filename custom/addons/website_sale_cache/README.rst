...
When multiple awkhad workers are used, the cache is updated for each one separately. So the page may be loaded slowly
...
* `IT-Projects LLC <https://it-projects.info>`__
      ...
      To get a guaranteed support you are kindly requested to purchase the module at `awkhad apps store <https://apps.awkhad.com/apps/modules/10.0/website_sale_cache/>`__.
...
Tested on Awkhad 10.0 1ffe85f1cb3defcbf932138e2fc13f3a81b34787
