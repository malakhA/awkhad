...
class ProductProduct(models.Model):
    ...
    module_path = fields.Char(
        related="awkhad_module_version_id.repository_branch_id.local_path",
        readonly=True)
    ...
    def _get_module_path(self):
        return (self.module_path + '/' +
                self.awkhad_module_version_id.technical_name)
        ...
        for product in self.filtered('module_path'):
            ...
            for dependent_pro in dependent_products.filtered('module_path'):
                tmp_module_path = os.path.join(
                    tmp_dir,
                    dependent_pro.awkhad_module_version_id.technical_name)
                shutil.copytree(
            ...
            tmp_module_path = os.path.join(
                tmp_dir, product.awkhad_module_version_id.technical_name)
