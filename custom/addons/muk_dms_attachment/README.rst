...
MuK Documents is a module to create, manage and view files directly within Awkhad.
MuK Documents Attachment allows to store Awkhad Attachments inside the Document
Management System. Attachments stored in the document management system are still
available as attachments in Awkhad. As with all other files, the storage type can
