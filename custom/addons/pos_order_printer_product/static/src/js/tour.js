awkhad.define('pos_order_printer_product.tour', function(require) {
    "use strict";

    var tour = require('web_tour.tour');


    tour.register('pos_order_printer_product_tour', {
        url: "/web",
        test: true,
        ...
        content: "<p>Click <b>Order</b> button for printing in <b>Kitchen</b></p>",
        position: "bottom"
    }
    ]);
});
