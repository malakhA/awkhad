...
Extendes the Preview Dialog to support Open Document files. Currently the 
following extensions are supported:

* Open Text Document (\*.odt, application/vnd.oasis.opendocument.text)
* Open Presentation Document (\*.odt, application/vnd.oasis.opendocument.presentation)
* Open Spreadsheet Document (\*.odt, application/vnd.oasis.opendocument.spreadsheet)
...
Go to a binary that contains a file and open the preview dialog to view
the preview.
