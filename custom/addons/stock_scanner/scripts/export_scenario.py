...
parser = argparse.ArgumentParser(
    description='Scenarios export script for Awkhad\'s stock_scanner module',
    formatter_class=argparse.ArgumentDefaultsHelpFormatter)

connection_group = parser.add_argument_group('Connection')
connection_group.add_argument(
    '--host', dest='host', default='localhost',
    help='Address of the Awkhad server.')
connection_group.add_argument(
    '-p', '--port', dest='port', default='8069',
    help='Port of the Awkhad server.')
connection_group.add_argument(
...
try:
    ...
    connection = awkhadrpc.AWKHAD(options.host, port=options.port)
    connection.login(
