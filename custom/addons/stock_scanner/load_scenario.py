    ...
    if extension == '.scenario':
        ...
        try:
            with awkhad.api.Environment.manage():
                ...
                env = awkhad.api.Environment(cr, uid, {'active_test': False})
...
# Monkey patch Awkhad's module file loading
# To be able to load scenarios from manifest file
awkhad.tools.convert_file = scenario_convert_file
awkhad.tools.convert.convert_file = scenario_convert_file
