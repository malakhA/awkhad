...
Restriction on the maximum partner attendance time. Each ten minutes awkhad checks for opened partner session, if a session lasts more then defined time it will be closed.
