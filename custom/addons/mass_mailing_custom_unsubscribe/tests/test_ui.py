...
class UICase(HttpCase):
    _tour_run = "awkhad.__DEBUG__.services['web_tour.tour'].run('%s')"
    _tour_ready = "awkhad.__DEBUG__.services['web_tour.tour'].tours.%s.ready"
    ...
    def setUp(self):
        ...
        self.mail_postprocess_patch = mock.patch(
            "awkhad.addons.mass_mailing.models.mail_mail.MailMail."
        ...
        # HACK https://github.com/awkhad/awkhad/pull/14429
