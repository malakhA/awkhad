...
awkhad.define('pos_multi_session', function(require){
    var exports = {};
    ...
    models.PosModel = models.PosModel.extend({
        ...
        ms_update_order: function(order, data) {
            if (order && order.finalized) {
                // if true, cannot be modified. - According to Awkhad
                return;
            }
            var pos = this;
    ...
    models.Orderline = models.Orderline.extend({
        initialize: function(){
            ...
            this.ms_info = {};
            if (!this.order){
                // probably impossible case in awkhad 10.0, but keep it here to remove doubts
                return;
            }
