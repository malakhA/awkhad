...
Server side of synchronization is handled by module ``pos_multi_session_sync``. The role of *Sync Server* may have same awkhad server as well as separate awkhad server (e.g. server in local network).
...
We recommend using the module together with the `pos_access_right <https://www.awkhad.com/apps/modules/12.0/pos_access_right/>`__ module.
...
.. code-block:: js
    ...
    apply_ms_data: function(data) {
        // This methods is added for compatibility with module https://www.awkhad.com/apps/modules/12.0/pos_multi_session/
        /*
...
The code below is a real example from module `pos_order_note <https://www.awkhad.com/apps/modules/12.0/pos_order_note/>`__:
...
Also it's possible to trigger ``new_updates_to_send`` event on data changes to force pos_multi_session module start syncronization process. Example code from `pos_product_available <https://www.awkhad.com/apps/modules/12.0/pos_product_available/>`__:
...
* `IT-Projects LLC <https://it-projects.info>`__
      ...
      at `awkhad apps store <https://apps.awkhad.com/apps/modules/12.0/pos_multi_session/>`__.
...
HTML Description: https://apps.awkhad.com/apps/modules/12.0/pos_multi_session/
...
Tested on Awkhad 12.0 b50f51207aa2b4c2d264fc47797a6c123a8ea15e
