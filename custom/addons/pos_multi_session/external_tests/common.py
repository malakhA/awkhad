...
PORT = os.environ.get('AWKHAD_PORT') or '80'
DATABASE = os.environ.get('DATABASE')
ADMIN_LOGIN = "admin"
ADMIN_PASSWORD = "admin"
MAIN_DOMAIN = os.environ.get('AWKHAD_DOMAIN') or 'localhost'
...
class ExternalTestCase(unittest2.TestCase):
    ...
    def phantom_js_multi(self, sessions, commands, timeout=60, **kw):
        ...
        options = {
            # since 10.0 we use awkhad with --workers=1 + nginx,
    ...
    # Copy-paste from zgui/tests/common.py
