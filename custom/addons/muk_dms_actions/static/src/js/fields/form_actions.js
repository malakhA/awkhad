...
awkhad.define('muk_dms_action.FormFileActions', function (require) {
"use strict";
...
var FormFileActions = AbstractFileActions.extend({
    events: {
        'click a.dropdown-item': '_onClickAction',
    },
    _render: function () {
    	if (this.value && this.value.count >= 1) {
    		this.$el.html(QWeb.render("muk_dms_actions.FormFileActions", {
...
registry.add('form.file_actions', FormFileActions);

return FormFileActions;
