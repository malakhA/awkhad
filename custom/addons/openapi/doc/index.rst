...
* Add ``openapi`` to `--load parameter <https://awkhad-development.readthedocs.io/en/latest/admin/server_wide_modules.html>`__, e.g.::

    ./awkhad-bin --workers=2 --load openapi,web --config=/path/to/awkhad.conf
...
For more examples visit https://awkhad-sync.sh website
