...
# License LGPL-3.0 or later (https://www.gnu.org/licenses/lgpl.html).
{
    ...
    # "live_test_url": "http://apps.it-projects.info/shop/product/DEMO-URL?version={AWKHAD_BRANCH}",
    "images": [],
    "version": "12.0.1.1.0",
    "application": False,
    ...
    "website": "https://apps.awkhad.com/apps/modules/12.0/pos_product_available/",
    "license": "LGPL-3",
    # "price": 9.00,
    # "currency": "EUR",
