...
class TestUi(awkhad.tests.HttpCase):
    ...
    def test_pos_product_available(self):
        ...
        self.phantom_js("/web",
                        "awkhad.__DEBUG__.services['web_tour.tour'].run('tour_pos_product_available', 500)",
                        "awkhad.__DEBUG__.services['web_tour.tour'].tours.tour_pos_product_available.ready",
