awkhad.define('pos_orderline_absolute_discount_tour.tour', function(require) {
"use strict";
    ...
    function goto_payment_screen_and_select_payment_method() {
        ...
        if (awkhad._modules.indexOf('pos_cashier_select') !== -1) {
    ...
    tour.register('pos_orderline_absolute_discount_tour', {test: true, url: '/web' }, steps);
});
