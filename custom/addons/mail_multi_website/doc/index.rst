...
Configure ``mail.catchall.domain`` per website. See Documentation of the module `Context-dependent values in System Parameters <https://apps.awkhad.com/apps/modules/10.0/ir_config_parameter_multi_company>`__.
...
To review properties by website use menu ``[[ Settings ]] >> Technical >> Parameters >> Company Properties``. See **How it works** in Documentation of module `Website Switcher in Backend <https://apps.awkhad.com/apps/modules/10.0/web_website>`__.
