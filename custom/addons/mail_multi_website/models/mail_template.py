...
import logging
from awkhad import models, fields, api, tools, _
from awkhad.exceptions import UserError
from awkhad.tools import pycompat
from awkhad.addons.mail.models.mail_template import format_date, format_tz, format_amount

_logger = logging.getLogger(__name__)
FIELDS = ['body_html', 'mail_server_id', 'report_template']

try:
    from awkhad.addons.mail.models.mail_template import mako_safe_template_env, mako_template_env
except ImportError:
...
class MailTemplate(models.Model):
    ...
    def write(self, vals):
        ...
        # TODO: will it work with ACA's partner_firstname module?
        if 'name' in vals:
