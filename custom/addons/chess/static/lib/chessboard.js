...
function expandConfig() {
  ...
  if (cfg.hasOwnProperty('pieceTheme') !== true ||
    ...
    cfg.pieceTheme = '/chess/static/img/chesspieces/wikipedia/{piece}.png';
  }
...
function beginDraggingPiece(source, piece, x, y) {
  ...
  if (source === 'spare') {
    DRAGGED_PIECE_LACATION = 'offboard';
  }
  else {
    DRAGGED_PIECE_LACATION = source;
  }
...
function updateDraggedPiece(x, y) {
  ...
  if (location === DRAGGED_PIECE_LACATION) return;

  // remove highlight from previous square
  if (validSquare(DRAGGED_PIECE_LACATION) === true) {
    $('#' + SQUARE_ELS_IDS[DRAGGED_PIECE_LACATION])
  ...
  if (typeof cfg.onDragMove === 'function') {
    cfg.onDragMove(location, DRAGGED_PIECE_LACATION,
      DRAGGED_PIECE_SOURCE, DRAGGED_PIECE,
      deepCopy(CURRENT_POSITION), CURRENT_ORIENTATION);
  }

  // update state
  DRAGGED_PIECE_LACATION = location;
}
