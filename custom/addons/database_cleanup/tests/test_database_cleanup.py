...
from awkhad.tools import config, mute_logger
from awkhad.tests.common import TransactionCase, at_install, post_install


# Use post_install to get all models loaded more info: awkhad/awkhad#13458
@at_install(False)
@post_install(True)
    ...
    def test_database_cleanup(self):
        ...
        with self.assertRaises(ProgrammingError):
            with self.env.registry.cursor() as cr:
                with mute_logger('awkhad.sql_db'):
