...
awkhad.define('pos_debt_notebook.pos', function (require) {
    "use strict";
                ...
                if (self.reload_debts_partner_ids.length > 0) {
                    ...
                    if (new_partners) {
                        self.load_new_partners().always(function(){
                            ...
                            // related PR: https://github.com/awkhad/awkhad/pull/26220
                            def.resolve();
                        });
                    } else {
                        def.resolve();
    ...
    screens.PaymentScreenWidget.include({
        ...
        (cf awkhad/addons/point_of_sale/static/src/js/screens.js line 1256)
