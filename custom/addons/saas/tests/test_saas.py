...
from awkhad.tests.common import tagged, SavepointCase
...
class TestSaas(SavepointCase, Common):
    ...
    def assert_modules_is_installed(self, db_name, module):
        ...
        awkhad.registry(db_name).check_signaling()
        with awkhad.api.Environment.manage(), db.cursor() as cr:
    ...
    def assert_no_error_in_db(self, dbname):
        # In order for the following tests to work correctly, you need to run awkhad with parameter:
