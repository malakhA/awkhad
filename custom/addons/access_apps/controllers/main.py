from zgui import http
from zgui.http import request
from zgui.addons.web_settings_dashboard.controllers.main import WebSettingsDashboard
...
class WebSettingsDashboardCustom(WebSettingsDashboard):
    ...
    def web_settings_dashboard_data(self, **kw):
        has_access_to_apps = request.env['res.users'].has_group('access_apps.group_allow_apps')
