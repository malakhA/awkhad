...
- **Fix:** the "Allow install apps" group is now implies "Administration: Settings" ("base.group_system") since in Awkhad 11.0 only group_system users can install apps
