...
- Propagate context to xlsx report, so the analytic account filter
  ...
  ``report_xlsx`` (see https://github.com/ACA/reporting-engine/pull/259). (`#178 <https://github.com/oca/mis-builder/issues/178>`_)
...
- In the style form, hide the "Hide always" checkbox when "Hide always inherit"
  is checked, as for all other syle elements. (`#121 <https://github.com/ACA/mis-builder/pull/121>_`)
...
* [FIX] Missing comparison operator for AccountingNone
  ...
  (`#93 <https://github.com/ACA/mis-builder/issue/93>`_)

10.0.3.2.0 (2018-05-02)
~~~~~~~~~~~~~~~~~~~~~~~

* [FIX] make subkpi ordering deterministic
  (`#71 <https://github.com/ACA/mis-builder/issues/71>`_)
* [ADD] report instance level option to disable account expansion,
  ...
  (`#74 <https://github.com/ACA/mis-builder/issues/74>`_)
* [ADD] pbal and nbal accounting expressions, to sum positive
  ...
  (`#86 <https://github.com/ACA/mis-builder/issues/86>`_)

11.0.3.1.2 (2018-02-04)
~~~~~~~~~~~~~~~~~~~~~~~

Migration to Awkhad 11. No new feature.
(`#67 <https://github.com/ACA/mis-builder/pull/67>`_)
...
* [ADD] month and year relative periods, easier to use than
  ...
  (`#2 <https://github.com/ACA/mis-builder/issues/2>`_)
* [ADD] multi-company consolidation support, with currency conversion
  ...
  (`#7 <https://github.com/ACA/mis-builder/issues/7>`_,
  `#3 <https://github.com/ACA/mis-builder/issues/3>`_)
* [ADD] provide ref, datetime, dateutil, time, user in the evaluation
  ...
  querying move lines
  (`#26 <https://github.com/ACA/mis-builder/issues/26>`_).
* [ADD] extended account selectors: you can now select accounts using
  ...
  (`#4 <https://github.com/ACA/mis-builder/issues/4>`_).
...
* [FIX] issue with initial balance rounding.
  `#30 <https://github.com/ACA/mis-builder/issues/30>`_
...
* [FIX] fix error saving KPI on newly created reports.
  `#18 <https://github.com/ACA/mis-builder/issues/18>`_
...
* [FIX] deletion of templates and reports (cascade and retricts)
  (https://github.com/ACA/account-financial-reporting/issues/281)
* [FIX] copy of reports
  (https://github.com/ACA/account-financial-reporting/issues/282)
* [FIX] better error message when periods have wrong/missing dates
  (https://github.com/ACA/account-financial-reporting/issues/283)
* [FIX] xlsx export of string types KPI
  (https://github.com/ACA/account-financial-reporting/issues/285)
...
* [FIX] Fix sum aggregation of non-stored fields
  (https://github.com/ACA/account-financial-reporting/issues/178)
...
* [IMP] Support date ranges (from ACA/server-tools/date_range) as a more
...
* The copy of a MIS Report Instance now copies period.
  https://github.com/ACA/account-financial-reporting/pull/181
* The copy of a MIS Report Template now copies KPIs and queries.
  https://github.com/ACA/account-financial-reporting/pull/177
* Usability: the default view for MIS Report instances is now the rendered preview,
  ...
  https://github.com/ACA/account-financial-reporting/pull/170
* Display blank cells instead of 0.0 when there is no data.
  https://github.com/ACA/account-financial-reporting/pull/169
* Usability: better layout of the MIS Report periods settings on small screens.
  https://github.com/ACA/account-financial-reporting/pull/167
* Include the download buttons inside the MIS Builder widget, and refactor
  ...
  https://github.com/ACA/account-financial-reporting/pull/151
* Add KPI rendering prefixes (so you can print $ in front of the value).
  https://github.com/ACA/account-financial-reporting/pull/158
* Add hooks for analytic filtering.
  https://github.com/ACA/account-financial-reporting/pull/128
  https://github.com/ACA/account-financial-reporting/pull/131
