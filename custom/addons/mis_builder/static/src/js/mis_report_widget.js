...
awkhad.define("mis_builder.widget", function(require) {
    "use strict";
    ...
    var MisReportWidget = AbstractField.extend(StandaloneFieldManagerMixin, {
        ...
        _instanceId: function() {
             ...
             * of Awkhad dashboards that are not designed to contain forms but
        ...
        /**
         * Hack to work around Awkhad not fetching display name for
