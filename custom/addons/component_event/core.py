...
class EventWorkContext(WorkContext):
    ...
    :class:`awkhad.addons.component.core.WorkContext` or your own
    subclass.
    ...
    a :class:`awkhad.addons.component.core.WorkContext` with collection.
    ...
    def work_on(self, model_name=None, collection=None):
        ...
        if collection is not None:
            if self.env is not collection.env:
                raise ValueError('the Awkhad env of the collection must be '
