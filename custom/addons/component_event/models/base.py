...
Extend the 'base' Awkhad Model to add Events related features.


"""

from awkhad import api, models
from awkhad.addons.component.core import _component_databases
    ...
    * ``on_record_unlink(self, record)``
    ...
    def _event(self, name, collection=None, components_registry=None):
        ...
        :type components_registry:
            :class:`awkhad.addons.components.core.ComponentRegistry`
        ...
        if not comp_registry or not comp_registry.ready:
            ...
            # This is a very special case, when the awkhad registry is being
            # built, it calls awkhad.modules.loading.load_modules().
