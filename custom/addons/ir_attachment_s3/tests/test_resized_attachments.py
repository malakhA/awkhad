...
from awkhad import api, exceptions
...
class TestResizedAttachments(HttpCase):
    ...
    def test_getting_cached_images_url_instead_computing(self):
        ...
        redirected_image = self.url_open(awkhad_image_url, timeout=30)
        redirected_image_medium = self.url_open(awkhad_image_medium_url, timeout=30)
        redirected_image_small = self.url_open(awkhad_image_small_url, timeout=30)
