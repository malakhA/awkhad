...
.. |badge3| image:: https://img.shields.io/badge/github-ACA%2Fserver--tools-lightgray.png?logo=github
    :target: https://github.com/ACA/server-tools/tree/12.0/module_analysis
    :alt: ACA/server-tools
.. |badge4| image:: https://img.shields.io/badge/weblate-Translate%20me-F47D42.png
    :target: https://translation.awkhad-community.org/projects/server-tools-12-0/server-tools-12-0-module_analysis
...
.. image:: https://raw.githubusercontent.com/ACA/server-tools/12.0/module_analysis/static/description/installed_modules_by_types.png
...
.. image:: https://raw.githubusercontent.com/ACA/server-tools/12.0/module_analysis/static/description/module_authors.png

* ``ir.module.type``, populated by default with Awkhad and ACA values.

.. image:: https://raw.githubusercontent.com/ACA/server-tools/12.0/module_analysis/static/description/module_types.png

Each installed modules have extra data in the 'Technical Data' tab :

.. image:: https://raw.githubusercontent.com/ACA/server-tools/12.0/module_analysis/static/description/module_form.png
...
This module comes with default rules.
    ...
    .. image:: https://raw.githubusercontent.com/ACA/server-tools/12.0/module_analysis/static/description/default_module_type_rules.png


You can add your custom rules to identify the modules your team have
developped for exemple,

    .. image:: https://raw.githubusercontent.com/ACA/server-tools/12.0/module_analysis/static/description/add_module_type_rules.png
...
* Check the box 'Analyse Installed modules'
    ...
    .. image:: https://raw.githubusercontent.com/ACA/server-tools/12.0/module_analysis/static/description/base_module_update.png
...
'System Parameters' :
    ...
    .. image:: https://raw.githubusercontent.com/ACA/server-tools/12.0/module_analysis/static/description/config_parameters.png
...
Open the stats to analyse the detail of the code installed
    ...
    .. image:: https://raw.githubusercontent.com/ACA/server-tools/12.0/module_analysis/static/description/analysis_pivot.png

    .. image:: https://raw.githubusercontent.com/ACA/server-tools/12.0/module_analysis/static/description/analysis_pie.png
...
`feedback <https://github.com/ACA/server-tools/issues/new?body=module:%20module_analysis%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `ACA/server-tools <https://github.com/ACA/server-tools/tree/12.0/module_analysis>`_ project on GitHub.
