...
from awkhad.addons.website_mass_mailing.controllers import main
...
class MassMailController(main.MassMailController):
    ...
    def subscribe(self, list_id, email, **post):
        ...
        contact = contact_obj.sudo().search([
            ...
            ('opt_out', '=', False),    # Needed until awkhad/awkhad#39604 is fixed
            ('is_blacklisted', '=', False),
        ], limit=1)
        # Needed until awkhad/awkhad#39604 is fixed
        if not contact:
            return result
