...
This module expands Awkhad functionality, allowing user to generate barcode
...
* Define a Barcode base: 
    ...
    * automaticaly by a sequence, if you want to let Awkhad to increment a
...
.. image:: https://awkhad-community.org/website/image/ir.attachment/5784_f2813bd/datas
   ...
   :target: https://runbot.awkhad-community.org/runbot/150/10.0

Bug Tracker
===========

Bugs are tracked on `GitHub Issues
<https://github.com/ACA/stock-logistics-barcode/issues>`_. In case of trouble, please
