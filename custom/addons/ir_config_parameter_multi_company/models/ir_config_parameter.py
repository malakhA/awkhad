...
from awkhad import models, fields, api, tools
from awkhad.addons.base.models.ir_config_parameter import IrConfigParameter as IrConfigParameterOriginal
...
class IrConfigParameter(models.Model):
    ...
    def get_param(self, key, default=False):
        if not self.env.context.get('force_company'):
            ...
            if website_id:
                ...
                # Warning. Since awkhad 11.0 it means that by default Administrator's company value is used
    ...
    def _get_param(self, key):
        ...
        # call undecorated super method. See awkhad/tools/cache.py::ormcache and http://decorator.readthedocs.io/en/stable/tests.documentation.html#getting-the-source-code
