...
To avoid it, add the module to ``--load`` parameter, e.g.::
    ...
    ./awkhad-bin --load=web,ir_config_parameter_multi_company --test-enable -i some_module ...
...
HTML Description: https://apps.awkhad.com/apps/modules/12.0/ir_config_parameter_multi_company/

Usage instructions: `<doc/index.rst>`_

Changelog: `<doc/changelog.rst>`_

Tested on Awkhad 12.0 80cef9e8c52ff7dc0715a7478a2288d3de7065df
