...
For understanding how multi-website values work see Documentation of `web_website <https://apps.awkhad.com/apps/modules/12.0/web_website/>`__
...
* ``database.expiration_date`` -- it's used in Awkhad EE
