...
_packagepath = 'awkhad.addons.mail_tracking_mailgun'
...
class TestMailgun(TransactionCase):
    ...
    def setUp(self):
        ...
        self.event = {
            'Message-Id': '<xxx.xxx.xxx-zgui-xxx-res.partner@test_db>',
            ...
            "items": [{
                ...
                "message": {
                    "headers": {
                        ...
                        "from": "Mr. Awkhad <mrawkhad@awkhad.com>",
    ...
    @mute_logger('awkhad.addons.mail_tracking_mailgun.models'
                 '.mail_tracking_email')
    ...
    def test_event_opened(self):
        ip = '127.0.0.1'
        user_agent = 'Awkhad Test/8.0 Gecko Firefox/11.0'
        os_family = 'Linux'
        ua_family = 'Firefox'
        ua_type = 'browser'
        self.event.update({
    ...
    def test_event_clicked(self):
        ...
        ua_family = 'Firefox'
        ua_type = 'browser'
        url = 'https://awkhad-community.org'
        self.event.update({
            'event': 'clicked',
            'city': 'Mountain View',
            'country': 'US',
