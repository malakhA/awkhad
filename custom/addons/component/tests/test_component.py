...
from awkhad.addons.component.exception import (
    NoComponentError,
...
class TestComponent(TransactionComponentRegistryCase):
    ...
    We test the chain awkhad Model -> generate a WorkContext instance -> Work
    with Component.

    Tests are inside Awkhad transactions, so we can work
    with Awkhad's env / models.
    """
