...
from awkhad.addons.component.core import (
    ComponentRegistry,
    MetaComponent,
    _get_addon_name,
)
...
def new_rollbacked_env():
    registry = awkhad.registry(common.get_db_name())
...
class TransactionComponentCase(common.TransactionCase, ComponentMixin):
    ...
    It it used like an usual Awkhad's TransactionCase, but it ensures
...
class SavepointComponentCase(common.SavepointCase, ComponentMixin):
    ...
    It it used like an usual Awkhad's SavepointCase, but it ensures
    that all the components of the current addon and its dependencies
    are loaded.
...
class ComponentRegistryCase(
    ...
    * :class:`SavepointComponentCase`
    ...
    :class:`awkhad.addons.component.core.ComponentRegistry` for the purpose of
    ...
    All the components of an Awkhad module::
...
class TransactionComponentRegistryCase(common.TransactionCase,
    ...
    """ Adds Awkhad Transaction in the base Component TestCase """
...
class SavepointComponentRegistryCase(common.SavepointCase,
                                     ComponentRegistryCase):
    """ Adds Awkhad Transaction with Savepoint in the base Component TestCase """
