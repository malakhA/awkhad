...
class ResCompany(models.Model):
    ...
    number_of_digits_to_match_from_end = fields.Integer(
        ...
        default=8,
        help="In several situations, Awkhad will have to find a "
        ...
        "in Awkhad is to try to match the end of the phone number in "
        "Awkhad with the N last digits of the phone number presented "
