...
from awkhad.tests.common import SavepointCase


class TestDisableExportGroup(SavepointCase):
    @patch('awkhad.addons.base_setup.models.ir_http.request')
    @patch('awkhad.addons.web_disable_export_group.models.ir_http.request')
    @patch('awkhad.addons.web.models.ir_http.request')
    @patch('awkhad.addons.web_tour.models.ir_http.request')
