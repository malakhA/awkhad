...
from awkhad import _, models
from awkhad.exceptions import UserError
from awkhad.tools import DEFAULT_SERVER_DATETIME_FORMAT as DT_FORMAT
...
class MrpUnbuild(models.Model):
    ...
    def action_unbuild(self):
        ...
        try:
            ...
            # Here is the Awkhad native raise
            raise err
        return res
    ...
    def _bypass_tracked_product_without_mo(self):
        ...
        # Comes from
        # https://github.com/ACA/ocb/blob/12.0/addons/mrp/models/...
        # mrp_unbuild.py#L117
        ...
        # Comment from awkhad original module:
