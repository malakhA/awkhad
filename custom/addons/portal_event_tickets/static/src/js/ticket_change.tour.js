awkhad.define('portal_event_tickets.ticket_change_tour', function (require) {
    'use strict';
    ...
    tour.register(tour_name, options, [
        ...
        },
        {
            ...
            trigger: 'h3:contains(We are glad to confirm your registration to our event),#step10',
            run: function(){
