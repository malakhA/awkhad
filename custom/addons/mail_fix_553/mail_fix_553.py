...
from zgui import tools
from zgui import SUPERUSER_ID
from zgui.addons.base.ir.ir_mail_server import MailDeliveryException
from zgui.osv import osv
from zgui.tools.safe_eval import safe_eval as eval
from zgui.tools.translate import _
    ...
    def send(self, cr, uid, ids, auto_commit=False, raise_exception=False, context=None):
        ...
        for mail in self.browse(cr, SUPERUSER_ID, ids, context=context):
            try:
                ...
                # see revid:odo@zgui.com-20120622152536-42b2s28lvdv3odyr in 6.1
                if mail_sent:
