...
class TimelogConfigSettings(models.TransientModel):
    ...
    normal_time_day = fields.Float(string='Set normal day time', help="""Setting time standards provided throughout the day""")
    good_time_day = fields.Float(string='Set good day time', help="""Set in excess of the time allowed for the day""")

    normal_time_week = fields.Float(string='Set normal week time', help="""Setting time standards provided throughout the week""")
    good_time_week = fields.Float(string='Set good week time', help="""Set in excess of the time allowed for the week""")
    ...
    def set_values(self):
        ...
        ICPSudo.set_param(key="project_timelog.time_warning_subtasks", value=self.time_warning_subtasks)
        ICPSudo.set_param(key="project_timelog.normal_time_day", value=self.normal_time_day)
        ICPSudo.set_param(key="project_timelog.good_time_day", value=self.good_time_day)
        ICPSudo.set_param(key="project_timelog.normal_time_week", value=self.normal_time_week)
        ICPSudo.set_param(key="project_timelog.good_time_week", value=self.good_time_week)
    ...
    def get_values(self):
        ...
        res.update(
            ...
            time_warning_subtasks=ICPSudo.get_param('project_timelog.time_warning_subtasks'),
