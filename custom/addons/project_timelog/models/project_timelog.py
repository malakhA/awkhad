...
from awkhad.exceptions import Warning as UserError
from awkhad.tools.translate import _
from awkhad.addons.bus.models.bus_presence import AWAY_TIMER
from awkhad.addons.bus.models.bus_presence import DISCONNECTION_TIMER
...
class AccountAnalyticLine(models.Model):
    ...
    def subtask_new_status(self):
        status = self.env["account.analytic.line"].search([('status', '!=', 'nonactive')])
        for e in status:
