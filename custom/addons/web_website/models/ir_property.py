...
from awkhad.addons.base.models.ir_property import TYPE2FIELD
...
class IrProperty(models.Model):
    ...
    def _update_values(self, values):
        ...
        Can be removed in first awkhad release with this patch: https://github.com/awkhad/awkhad/pull/26556
        """
    ...
    def get_multi(self, name, model, ids):
        # Due to https://github.com/awkhad/awkhad/commit/b6d32de31e0e18a506ae06dc27561d1d078f3ab1 commit
        ...
        # for some reason html field type is missed in TYPE2FIELD https://github.com/awkhad/awkhad/pull/26556/files
        if field.type == 'html':
