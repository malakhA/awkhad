...
* TODO: Since awkhad 12, there is another switcher at ``[[ Website ]] >> Dashboard`` menu. It has to be syncronized with the switcher of this module, i.e. hide default one and use value of this module switcher.
...
* `IT-Projects LLC <https://it-projects.info>`__
      ...
      at `awkhad apps store <https://apps.awkhad.com/apps/modules/12.0/web_website/>`__.
...
HTML Description: https://apps.awkhad.com/apps/modules/12.0/web_website/
...
Tested on Awkhad 12.0 d75de9ae5370869eaa220f5fdfb335d1b7e40acf
