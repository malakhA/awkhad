...
If nothing works, add a debugger in the first line of ``_search method`` and enable debug mode in Awkhad. When you write something in a many2one field, javascript debugger should pause. If not verify your installation.
