...
awkhad.define('web_m2x_options.web_m2x_options', function (require) {
    "use strict";
                    ...
                    if (can_search_more || search_more_undef || search_more) {
                        values.push({
                            ...
                            action: function () {
                                ...
                                // to Awkhad implementation here:
                                // https://github.com/awkhad/awkhad/commit/8c3cdce539d87775b59b3f2d5ceb433f995821bf
                                self._rpc({
                                        model: self.field.relation,
                                        method: 'name_search',
                                        kwargs: {
