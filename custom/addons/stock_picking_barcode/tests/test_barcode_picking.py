...
class TestBarcodePickingUi(awkhad.tests.HttpCase):
    ...
    def test_stock_picking_barcode(self):
        ...
        self.phantom_js("/web",
                        "awkhad.__DEBUG__.services['web_tour.tour'].run('tour_stock_picking_barcode', 1000)",
                        "awkhad.__DEBUG__.services['web_tour.tour'].tours.tour_stock_picking_barcode.ready",
                        login="admin")
