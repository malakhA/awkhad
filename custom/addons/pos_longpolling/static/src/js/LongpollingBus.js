awkhad.define('pos_longpolling.LongpollingBus', function(require){
    "use strict";
        ...
        _poll: function () {
            ...
            this._pollRpc.then(function (result) {
                ...
                if (error && error.message === "XmlHttpRequestError abort") {
                    ...
                    self._pollRetryTimeout = setTimeout(self._poll.bind(self), self.ERROR_RETRY_DELAY + (Math.floor((Math.random()*20)+1)*1000));
                }
            });
        },
    });
