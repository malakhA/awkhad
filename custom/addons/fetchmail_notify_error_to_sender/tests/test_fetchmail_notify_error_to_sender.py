...
import socket
from awkhad.addons.test_mail.data.test_mail_data import MAIL_TEMPLATE
from awkhad.addons.test_mail.tests.test_mail_gateway import TestMailgateway
    ...
    def test_message_process(self):
        ...
        with self.assertRaises(ValueError):
            self.format_and_process_with_context(
                ...
                subject='spam',
                extra='In-Reply-To: <12321321-zgui-%d-mail.test.simple@%s'
                      '>' % (self.test_record.id,
                             socket.gethostname(),
                             ),
                ctx={
