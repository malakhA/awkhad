...
from awkhad.exceptions import RedirectWarning, ValidationError, UserError
...
class IntrastatProductDeclaration(models.Model):
    ...
    def _get_incoterm(self, inv_line):
        ...
        # cf https://github.com/awkhad/awkhad/issues/31641
    ...
    def _prepare_declaration_line(self, computation_lines):
        ...
        # round, otherwise awkhad with truncate (6.7 -> 6... instead of 7 !)
        for field in fields_to_sum:
