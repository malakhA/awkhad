...
This module is very similar to the module *account_analytic_required* available in the ACA project `account-analytic <https://github.com/ACA/account-analytic>`_.
