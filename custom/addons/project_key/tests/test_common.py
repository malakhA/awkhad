...
from awkhad.tests.common import TransactionCase, HttpCase
...
class TestCommon(TransactionCase):
    ...
    def setUp(self):
        ...
        self.project_1 = self.Project.create({'name': 'ACA'})
        self.project_2 = self.Project.create({'name': 'Awkhad', 'key': 'AWKHAD'})
